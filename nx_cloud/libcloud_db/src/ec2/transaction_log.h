...
public:
    ...
    void startDbTransaction(
        ...
        nx::utils::MoveOnlyFunc<nx::db::DBResult(db::QueryContext*)> dbUpdateFunc,
...
private:
    ...
    std::map<db::QueryContext*, DbTransactionContext> m_dbTransactionContexts;
