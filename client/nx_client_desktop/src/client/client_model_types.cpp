...
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(QnBackgroundImage, (json)(eq), QnBackgroundImage_Fields, (lazy, true));
...
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(QnWorkbenchState, (json), QnWorkbenchState_Fields, (lazy, true));
