...
private:
    ...
    QN_BEGIN_PROPERTY_STORAGE(VARIABLE_COUNT)
        ...
        QN_DECLARE_RW_PROPERTY(QSet<QnSystemHealth::MessageType>, popupSystemHealth, setPopupSystemHealth,      POPUP_SYSTEM_HEALTH,        QnSystemHealth::allVisibleMessageTypes())
