#include "time_syncronization_widget_watcher.h"
...
{
    TimeSynchronizationWidgetWatcher* q = nullptr;

public:
    Private(TimeSynchronizationWidgetWatcher* q, TimeSynchronizationWidgetStore* store) :
        QObject(),
        q(q),
        m_store(store),
...
TimeSynchronizationWidgetWatcher::TimeSynchronizationWidgetWatcher(
...
void TimeSynchronizationWidgetWatcher::updateTimestamps()
{
    d->updateTimestamps();
}
