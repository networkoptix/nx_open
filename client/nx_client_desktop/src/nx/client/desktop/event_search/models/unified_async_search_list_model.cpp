    ...
    m_busyIndicatorModel(new BusyIndicatorModel(this))
{
    ...
    auto concatenationModel = new ConcatenationListModel({m_sourceModel, m_busyIndicatorModel},
        this);

    m_filterModel->setSourceModel(concatenationModel);
    m_filterModel->setFilterRole(Qn::ResourceSearchStringRole);
    m_filterModel->setFilterCaseSensitivity(Qt::CaseInsensitive);

    setSource(m_filterModel);
}
