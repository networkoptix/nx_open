...
*/
api::ResultType::Value restartClient(
    nx::utils::SoftwareVersion version = {}, const QString& auth = {});
...
api::ResultType::Value startInstallation(
    const nx::utils::SoftwareVersion& version, unsigned int* installationID);
...
api::ResultType::Value installZip(
    const nx::utils::SoftwareVersion& version, const QString& zipFileName);
...
api::ResultType::Value getInstallationStatus(
    unsigned int installationID, api::InstallationStatus::Value* const status, float* progress);
