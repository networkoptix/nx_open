...
int QnMediaResourceWidget::calculateButtonsVisibility() const
{
    ...
    if (m_camera
        && m_camera->hasAnyOfPtzCapabilities(Ptz::Capability::ContinuousPtzCapabilities)
        && !m_camera->hasAnyOfPtzCapabilities(Ptz::Capability::VirtualPtzCapability)
...
{
    bool ptzEnabled =
        checked && (m_camera && (m_camera->getPtzCapabilities() & Ptz::Capability::ContinuousPtzCapabilities));
