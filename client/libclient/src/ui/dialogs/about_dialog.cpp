...
void QnAboutDialog::retranslateUi()
{
    ...
    QString appName = lit("<b>%1™ %2</b>")
        .arg(QnAppInfo::organizationName())
        .arg(qApp->applicationDisplayName());

    QStringList credits;
    credits << tr("%1 uses the following external libraries:").arg(appName);
    credits << lit("<b>Qt v.%1</b> - Copyright © 2012 Nokia Corporation.").arg(QLatin1String(QT_VERSION_STR));
    credits << QString();
    credits << lit("<b>FFMpeg %1</b> - Copyright © 2000-2012 FFmpeg developers.").arg(versionString(QnAppInfo::ffmpegVersion()));
    credits << lit("<b>LAME 3.99.0</b> - Copyright © 1998-2012 LAME developers.");
    credits << lit("<b>OpenAL %1</b> - Copyright © 2000-2006 %2.")
        .arg(nx::audio::AudioDevice::instance()->versionString())
        .arg(nx::audio::AudioDevice::instance()->company());
    credits << lit("<b>SIGAR %1</b> - Copyright © 2004-2011 VMware Inc.").arg(versionString(QnAppInfo::sigarVersion()));
    credits << lit("<b>Boost %1</b> - Copyright © 2000-2012 Boost developers.").arg(versionString(QnAppInfo::boostVersion()));
