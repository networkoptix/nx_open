...
QnLayoutResourcePtr LiteClientLayoutHelper::createLayoutForServer(const QnUuid& serverId)
{
...
QnLayoutResourcePtr LiteClientLayoutHelper::findLayoutForServer(const QnUuid& serverId)
{
    if (serverId.isNull())
        return QnLayoutResourcePtr();
