...
static const bool global_show_item_text = false; // ###

CLImageItem::CLImageItem(int max_width, int max_height, QString name)
	: CLAbstractSceneItem(max_width, max_height,name),
...
void CLImageItem::drawInfoText(QPainter* painter)
{
	...
	if (m_showimagesize)
		text += "(" + QString::number(imageWidth()) + "x" + QString::number(imageHeight()) + " ";
