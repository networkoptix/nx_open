...
static const int INITIAL_LIVE_MEDIA_LEN_THRESHOLD = 50*1000ll;   // do not sleep in live mode if queue is large
static const int MAX_LIVE_MEDIA_LEN_THRESHOLD = 100*1000ll;   // do not sleep in live mode if queue is large
