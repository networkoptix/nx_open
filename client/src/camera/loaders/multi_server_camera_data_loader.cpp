...
int QnMultiServerCameraDataLoader::loadInternal(const QnMediaServerResourcePtr &server, const QnVirtualCameraResourcePtr &camera, const QString &filter, const qint64 resolutionMs) {
