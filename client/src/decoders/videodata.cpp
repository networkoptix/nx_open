...
void downscalePlate_factor2_sse(uchar *dst, const unsigned int dst_stride, const uchar *src,
...
void downscalePlate_factor4_sse(uchar *dst, const unsigned int dst_stride, const uchar *src,
                                const unsigned int width, const unsigned int src_stride, unsigned int height)
{
    unsigned int y = 0;
    int round_width = width / 32 * 32;
...
void downscalePlate_factor8_sse(uchar *dst, const unsigned int dst_stride, const uchar *src,
                                const unsigned int width, const unsigned int src_stride, unsigned int height)
{
    height = height / 8 * 8;
    int round_width = width / 32 * 32;
...
void CLVideoDecoderOutput::copyPlane(uchar *dst, const uchar *src, int width, int dst_stride,  int src_stride, int height)
{
...
void CLVideoDecoderOutput::downscalePlate_factor2(uchar *dst, const uchar *src, int src_width, int src_stride, int src_height)
{
...
void CLVideoDecoderOutput::downscalePlate_factor4(uchar *dst, const uchar *src, int src_width, int src_stride, int src_height)
{
    const uchar *src_line1 = src;
...
void CLVideoDecoderOutput::downscalePlate_factor8(uchar *dst, const uchar *src, int src_width, int src_stride, int src_height)
{
    const uchar *src_line1 = src;
...
bool CLVideoDecoderOutput::equalPlanes(const uchar *plane1, const uchar *plane2, int width,
                                       int stride1, int stride2, int height, int max_diff)
{
    const uchar *p1 = plane1;
    const uchar *p2 = plane2;
