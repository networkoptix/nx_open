...
bool DxvaDecoderContext::setup(void **hw, FOURCC *chroma, int width, int height)
{
...
bool DxvaDecoderContext::extract(AVFrame *ff)
{
    LPDIRECT3DSURFACE9 d3d = (LPDIRECT3DSURFACE9)(uintptr_t)ff->data[3];
...
bool DxvaDecoderContext::newDxva(int codec_id)
{
...
bool DxvaDecoderContext::isHardwareAcceleration() const
{
    return m_hardwareAcceleration;
}

void DxvaDecoderContext::setHardwareAcceleration(bool hardwareAcceleration)
{
    m_hardwareAcceleration = hardwareAcceleration;
}

DxvaSupportObject* DxvaDecoderContext::va()
{
    return m_va;
}

picture_t* DxvaDecoderContext::pict()
{
    return m_pict;
}
