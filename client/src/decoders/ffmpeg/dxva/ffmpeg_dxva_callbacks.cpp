#include "ffmpeg_dxva_callbacks_p.h"

#include "dxva_p.h"

#include "utils/common/log.h"

int FFmpegDXVACallbacks::ffmpeg_GetFrameBuf(struct AVCodecContext *p_context,AVFrame *p_ff_pic)
{
    DxvaDecoderContext *dec = (DxvaDecoderContext *)p_context->opaque;
...
void FFmpegDXVACallbacks::ffmpeg_ReleaseFrameBuf(struct AVCodecContext *p_context, AVFrame *p_ff_pic)
{
    DxvaDecoderContext *dec = (DxvaDecoderContext *)p_context->opaque;
...
PixelFormat FFmpegDXVACallbacks::ffmpeg_GetFormat( AVCodecContext *p_codec, const enum PixelFormat *pi_fmt )
{
    DxvaDecoderContext *dec = (DxvaDecoderContext *)p_codec->opaque;
