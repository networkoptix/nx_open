...
public:
    ...
    GraphicsView(QGraphicsScene *scene, QWidget* mainWnd);
    ...
    void setAllItemsQuality(QnStreamQuality q, bool increase);
    void closeAllDlg();
    ...
    void deviceAdded(const QnResourcePtr &device);
...
private:
    ...
    void removeFileDeviceItem(CLAbstractSceneItem* aitem);
