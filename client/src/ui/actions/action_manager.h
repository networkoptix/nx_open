...
public:
     ...
     */
    void registerAlias(QnActions::Type id, QnActions::Type targetId);

    /**
     * \param id                        Id of the action to get.
     * \returns                         Action for the given id, or NULL if no such action exists.
     */
    QnAction *action(QnActions::Type id) const;
     ...
     */
    bool canTrigger(QnActions::Type id, const QnActionParameters &parameters = QnActionParameters());
     ...
     */
    void trigger(QnActions::Type id, const QnActionParameters &parameters = QnActionParameters());
     ...
     */
    bool triggerIfPossible(QnActions::Type id, const QnActionParameters &parameters = QnActionParameters());
    ...
    QMenu *newMenu(QnActions::Type rootId, Qn::ActionScope scope, QWidget *parent  = NULL, const QnActionParameters &parameters = QnActionParameters(), CreationOptions options = 0);
     ...
     */
    void redirectAction(QMenu *menu, QnActions::Type sourceId, QAction *targetAction);

signals:
    void menuAboutToShow(QMenu* menu);
    void menuAboutToHide(QMenu* menu);

    void actionRegistered(QnActions::Type id);
...
protected:
    ...
    bool redirectActionRecursive(QMenu *menu, QnActions::Type targetId, QAction *targetAction);
...
private:
    ...
    QHash<QnActions::Type, QnAction *> m_actionById;

    /** Mapping from action to action id. */
    QHash<QnAction *, QnActions::Type> m_idByAction;
