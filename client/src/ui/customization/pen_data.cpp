...
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(Qt::PenStyle, static)
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(Qt::PenCapStyle, static)
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(Qt::PenJoinStyle, static)
