...
class GraphicsScrollBarPrivate : public AbstractGraphicsSliderPrivate
{
...
bool GraphicsScrollBarPrivate::updateHoverControl(const QPoint &pos)
{
...
QStyle::SubControl GraphicsScrollBarPrivate::newHoverControl(const QPoint &pos)
{
    Q_Q(GraphicsScrollBar);
...
*/
void GraphicsScrollBar::initStyleOption(QStyleOptionSlider *option) const
{
    if (!option)
        return;
...
*/
GraphicsScrollBar::GraphicsScrollBar(QWidget *parent)
    : QAbstractSlider(*new GraphicsScrollBarPrivate, parent)
{
...
/*!
    ...
    initial \l {QAbstractSlider::value} {value} of 0.
*/
GraphicsScrollBar::GraphicsScrollBar(Qt::Orientation orientation, QWidget *parent)
    : QAbstractSlider(*new GraphicsScrollBarPrivate, parent)
{
...
*/
GraphicsScrollBar::GraphicsScrollBar(QWidget *parent, const char *name)
    : QAbstractSlider(*new GraphicsScrollBarPrivate, parent)
{
...
/*!
    ...
    argument and then use setObjectName() instead.
*/
GraphicsScrollBar::GraphicsScrollBar(Qt::Orientation orientation, QWidget *parent, const char *name)
    : QAbstractSlider(*new GraphicsScrollBarPrivate, parent)
{
    setObjectName(QString::fromAscii(name));
    d_func()->orientation = orientation;
...
/*!
    ...
    argument and then use setObjectName() instead.
*/
GraphicsScrollBar::GraphicsScrollBar(int minimum, int maximum, int lineStep, int pageStep,
...
/*! \reimp */
void GraphicsScrollBar::contextMenuEvent(QContextMenuEvent *event)
{
...
/*! \reimp */
QSize GraphicsScrollBar::sizeHint() const
{
    ensurePolished();
    QStyleOptionSlider opt;
    initStyleOption(&opt);
...
/*!
    \reimp
*/
void GraphicsScrollBar::paintEvent(QPaintEvent *)
{
    Q_D(GraphicsScrollBar);
    QPainter p(this);
    QStyleOptionSlider opt;
...
/*!
    \reimp
*/
void GraphicsScrollBar::mousePressEvent(QMouseEvent *e)
{
    Q_D(GraphicsScrollBar);
...
/*!
    \reimp
*/
void GraphicsScrollBar::mouseReleaseEvent(QMouseEvent *e)
{
    Q_D(GraphicsScrollBar);
    if (!d->pressedControl)
        return;
...
/*!
    \reimp
*/
void GraphicsScrollBar::mouseMoveEvent(QMouseEvent *e)
{
    Q_D(GraphicsScrollBar);
    if (!d->pressedControl)
        return;
...
int GraphicsScrollBarPrivate::pixelPosToRangeValue(int pos) const
{
    Q_Q(const GraphicsScrollBar);
    QStyleOptionSlider opt;
    q->initStyleOption(&opt);
...
*/
Q_GUI_EXPORT QStyleOptionSlider qt_qscrollbarStyleOption(GraphicsScrollBar *scrollbar)
{
    QStyleOptionSlider opt;
