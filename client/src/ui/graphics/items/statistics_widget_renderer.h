#ifndef QN_STATISTICS_WIDGET_RENDERER_H
#define QN_STATISTICS_WIDGET_RENDERER_H
...
class QnStatisticsWidgetRenderer: public QnResourceWidgetRenderer {
    Q_OBJECT;
public:
    QnStatisticsWidgetRenderer(int channelCount, QObject *parent = NULL, const QGLContext *context = NULL);

    void update();

    virtual ~QnStatisticsWidgetRenderer();
...
#endif // QN_STATISTICS_WIDGET_RENDERER_H
