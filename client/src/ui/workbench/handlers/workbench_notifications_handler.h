...
public:
    ...
    void addSystemHealthEvent(QnSystemHealth::MessageType message, const QnResourceList &resources);
signals:
    void systemHealthEventAdded(QnSystemHealth::MessageType message, const QnResourceList &resources);
