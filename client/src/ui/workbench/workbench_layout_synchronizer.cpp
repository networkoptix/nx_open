...
void QnWorkbenchLayoutSynchronizer::initialize() {
    ...
    connect(m_resource, &QnLayoutResource::resourceChanged,         this, &QnWorkbenchLayoutSynchronizer::at_resource_resourceChanged); //TODO: #GDM get rid of resourceChanged
