...
public:
    ...
    */
    void query(qint64 fromMsec, qint64 toMsec, QnNetworkResourcePtr camRes = QnNetworkResourcePtr(), QnId businessRuleId = QnId());
private slots:
    void at_gotEvents(int requestNum, int httpStatus, const QnAbstractBusinessActionList& events);
private:
