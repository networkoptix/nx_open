...
class NxOpenConan(ConanFile):
    ...
    ffmpeg_version_and_revision = "4.4#4061970d37e11f1b82a758233b64d91a"
    ...
    def build_requirements(self):
        ...
        self.build_requires("apidoctool/3.0" "#44b1faa25635d2f22a723b7bfc8c6188")
    ...
    def requirements(self):
        ...
        self.requires("qt/6.5.3" "#0721d983a4804e0bfd3b1bfb2b8eaadd")
