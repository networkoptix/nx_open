...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(const char *url)
{	this->soap = soap_new();
	this->own = true;
	CreatePullPointBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = url;
...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(const char *url, soap_mode iomode)
{	this->soap = soap_new();
	this->own = true;
	CreatePullPointBindingProxy_init(iomode, iomode);
	soap_endpoint = url;
...
{	struct soap *soap = this->soap;
	struct __tev_cpb__CreatePullPoint soap_tmp___tev_cpb__CreatePullPoint;
	if (endpoint)
		soap_endpoint = endpoint;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___tev_cpb__CreatePullPoint.oasisWsnB2__CreatePullPoint = oasisWsnB2__CreatePullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___tev_cpb__CreatePullPoint(soap, &soap_tmp___tev_cpb__CreatePullPoint);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___tev_cpb__CreatePullPoint(soap, &soap_tmp___tev_cpb__CreatePullPoint, "-tev-cpb:CreatePullPoint", NULL)
	...
	if (!oasisWsnB2__CreatePullPointResponse)
		return soap_closesock(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	oasisWsnB2__CreatePullPointResponse->soap_get(soap, "oasisWsnB2:CreatePullPointResponse", "");
	if (soap->error)
