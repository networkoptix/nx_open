...
const nxpl::NX_GUID kDriverGuid = {{
    0xB1, 0x4A, 0x8D, 0x7B, 0x80, 0x09, 0x4D, 0x38,
    0xA6, 0x0D, 0x04, 0x13, 0x93, 0x45, 0x43, 0x2E}};

const nxpl::NX_GUID kLineCrossingEventGuid = {{
    0x7E, 0x94, 0xCE, 0x15, 0x3B, 0x69, 0x47, 0x19,
    0x8D, 0xFD, 0xAC, 0x1B, 0x76, 0xE5, 0xD8, 0xF4}};

const nxpl::NX_GUID kObjectInTheAreaEventGuid = {{
    0xB0, 0xE6, 0x40, 0x44, 0xFF, 0xA3, 0x4B, 0x7F,
    0x80, 0x7A, 0x06, 0x0C, 0x1F, 0xE5, 0xA0, 0x4C}};
...
const nxpl::NX_GUID kHumanFaceObjectGuid = {{
    0xC2, 0x3D, 0xEF, 0x4D, 0x04, 0xF7, 0x4B, 0x4C,
    0x99, 0x4E, 0x0C, 0x0E, 0x6E, 0x8B, 0x12, 0xCB}};
