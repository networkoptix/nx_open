...
BasePipeline::BasePipeline(const gstreamer::ElementName& pipelineName, Plugin* plugin):
...
bool BasePipeline::pushDataPacket(sdk::metadata::DataPacket* dataPacket)
{
    if (!dataPacket)
        return true;
...
sdk::metadata::DataPacket* BasePipeline::nextDataPacket()
{
...
void BasePipeline::handleMetadata(sdk::metadata::MetadataPacket* packet)
{
