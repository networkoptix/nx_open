/**
    This is modified version of https://github.com/chrisbateman/impetus

    Modifications: added start,stop,release events for better handling in code
*/
...
(function (global, factory) {
    ...
    window.Impetus = function Impetus(_ref) {
        var _ref$source = _ref.source;
        var sourceEl = _ref$source === undefined ? document : _ref$source;
        var updateCallback = _ref.update;
        var stopCallback = _ref.stop;
        var releaseCallback = _ref.release;
        var startCallback = _ref.start;
        ...
        (function init() {
            ...
            if (!stopCallback) {
                throw new Error('IMPETUS: stop function not defined.');
            }
            if(!releaseCallback){
                throw new Error('IMPETUS: release function not defined.');
            }

            if (!startCallback) {
                throw new Error('IMPETUS: start function not defined.');
            }
        ...
        function callStopCallback() {
            stopCallback.call(sourceEl, targetX, targetY);
        }
        function callStartCallback(event) {
            startCallback.call(sourceEl, targetX, targetY, event);
        }

        function callReleaseCallBack(){
            releaseCallback.call(sourceEl, targetX, targetY);
        }
        /**
