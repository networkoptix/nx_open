...
-(NSURL*) videoUrl {
    NSString *path = [NSString stringWithFormat:@"/proxy/http/%@:%@/media/%@.mpjpeg?resolution=240p&qmin=30&qmax=30", _server.streamingUrl.host, _server.streamingUrl.port, _physicalId];
