...
module.exports = {
    ...
    entry: {
        ...
        vendor: './vendor.ts',
        styles: '../health_monitor/entrypoint.js',
        appnew: '../health_monitor/main.ts'
    },
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: '../health_monitor/health-monitor-index-template.html',
            filename: 'index.html',
            inject: false,
            chunks: ['commons', 'polyfills', 'vendor', 'styles', 'appnew'],
    ...
    module: {
        rules: [
            ...
            },
            {
                test: /\.html$/,
                include: /app/,
                exclude: /health-monitor-index-template\.html$/,
                use: ['html-loader']
            },
            {
