(function () {
    ...
    window.TimelineActions.prototype.setPositionProvider = function (positionProvider) {
        this.positionProvider = positionProvider;
    };
    
    window.TimelineActions.prototype.updatePlayingState = function (playingPosition) {
        this.scaleManager.updatePlayingState(playingPosition, this.positionProvider.liveMode, this.positionProvider.playing);
        
    };
    
    window.TimelineActions.prototype.playPause = function () {
    ...
    window.TimelineActions.prototype.delayWatchingPlayingPosition = function () {
        var self = this;
    ...
    window.TimelineActions.prototype.stopAnimatingMove = function () {
    ...
    window.TimelineActions.prototype.updatePosition = function () {
        var self = this;
    ...
    window.TimelineActions.prototype.setClickedCoordinate = function (mouseX) {
    ...
    window.TimelineActions.prototype.scrollingStart = function (left, speed) {
    ...
    window.TimelineActions.prototype.scrollingStop = function () {
        if (this.scrollingNow) {
    ...
    window.TimelineActions.prototype.scrollByPixels = function (pixels) {
    ...
    window.TimelineActions.prototype.zoomTo = function (zoomTarget, zoomCoordinate, instant) {
        ...
        self.scaleManager.checkZoomAsync(zoomTarget).then(function () {
            // prevent calling $digest if it already in progress
            // as per Angular discussion "For future-proofing reasons, you should not use $$phase"
            setTimeout(function () {
                self.scope.$digest();
            });
        });
    ...
    window.TimelineActions.prototype.fullZoomOut = function () {
    ...
    window.TimelineActions.prototype.zoomByWheel = function (clicks, mouseOverElements, mouseXOverTimeline) {
    ...
    window.TimelineActions.prototype.scrollingToCursorStop = function () {
    ...
    window.TimelineActions.prototype.scrollingToCursorStart = function () {
        var self = this;
    ...
    window.TimelineActions.prototype.scrollbarSliderDragStart = function (mouseX) {
        this.scaleManager.stopWatching();
        this.catchScrollBar = mouseX;
        this.catchScrollSlider = this.scaleManager.scrollSlider();
    };
    
    window.TimelineActions.prototype.scrollbarSliderDrag = function (mouseX) {
    ...
    window.TimelineActions.prototype.scrollbarSliderDragEnd = function () {
        if (this.catchScrollBar) {
    ...
    window.TimelineActions.prototype.timelineDragStart = function (mouseX) {
        this.scaleManager.stopWatching();
        this.catchTimeline = mouseX;
        this.scaleManager.dragDate = this.scaleManager.screenCoordinateToDate(mouseX);
    };
    
    window.TimelineActions.prototype.timelineDrag = function (mouseX) {
    ...
    window.TimelineActions.prototype.timelineDragEnd = function () {
        if (this.catchTimeline) {
            this.scaleManager.releaseWatching();
            this.catchTimeline = false;
