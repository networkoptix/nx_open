    ...
    angular
        ...
        function ($http, NgbModal, $q, $location, configService, NxDialogsService, languageService) {
            ...
            function openDialog(settings) {
                ...
                modalInstance = NgbModal.open(settings.template + `: This dialog have to be moved! Ng-Bootstrap requires dialog content and not templateUrl`, { /* settings */});
            ...
            return {
                ...
                noClientDetected: function () {
                    ...
                    return this
                        .confirm(lang.downloads.noClientDetectedMessage, lang.downloads.noClientDetectedTitle, lang.downloads.action, 'btn-primary', lang.dialogs.cancelButton)
                        .then((result) => {
                        if (result) {
