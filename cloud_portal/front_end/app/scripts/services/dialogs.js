(function () {
    ...
    angular
    .module('cloudApp')
    .run(['$http', '$templateCache', 'CONFIG', function ($http, $templateCache, CONFIG) {
    ...
    .factory('dialogs', ['$http', 'NgbModal', '$q', '$location', 'ngToast', 'CONFIG',
        function ($http, NgbModal, $q, $location, ngToast, CONFIG) {
            ...
            function openDialog(settings) {
                ...
                var content = settings.template || CONFIG.viewsDir + 'components/dialog.html';
                // Check 401 against offline
                modalInstance = NgbModal
                .open(
                    content,
                    {   /* Options */
    ...
    .controller('DialogCtrl', ['$scope', '$uibModalInstance', 'settings',
