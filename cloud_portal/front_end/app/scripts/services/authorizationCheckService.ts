    ...
    function AuthorizationCheckService($rootScope, $q, $localStorage, $base64, cloudApi, configService, nxDialogsService, languageService, $location) {
        ...
        function logoutAuthorised () {
            ...
            this.get().then(function () {
                ...
                nxDialogsService.confirm(null /*L.dialogs.logoutAuthorisedText*/,
                    languageService.lang.dialogs.logoutAuthorisedTitle,
                    languageService.lang.dialogs.logoutAuthorisedContinueButton,
                    null,
