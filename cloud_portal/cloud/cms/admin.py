...
class ContextAdmin(admin.ModelAdmin):
    ...
    def context_actions(self, obj):
        return format_html('<a class="button" href="/admin/cms/context_editor/?context={}">Edit Context</a>',
                            obj.name)
...
class ContentVersionAdmin(admin.ModelAdmin):
    ...
    def content_version_actions(self, obj):
        return format_html('<a class="button" href="/admin/cms/review_version/?id={}">View Data Records</a>',
                            obj.id)
