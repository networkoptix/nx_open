...
start /B /WAIT msiexec /I "bin\${final.artifact.name}.msi" /qb- /Lv* "install.log" APPSERVER_PASSWORD="%EC_PASSWORD%" APPSERVER_PORT="%EC_PORT%" PROXY_PORT="%PROXY_PORT%" SERVER_APPSERVER_HOST="%EC_HOST%" SERVER_APPSERVER_PORT="%EC_PORT%" SERVER_APPSERVER_LOGIN="%EC_LOGIN%" SERVER_APPSERVER_PASSWORD="%EC_PASSWORD%" SERVER_RTSP_PORT="%SERVER_RTSP_PORT%" SERVER_API_PORT="%SERVER_API_PORT%" CLIENT_APPSERVER_HOST="%EC_HOST%" CLIENT_APPSERVER_PORT="%EC_PORT%" CLIENT_APPSERVER_LOGIN="%EC_LOGIN%" CLIENT_APPSERVER_PASSWORD="%EC_PASSWORD%" SERVER_DIRECTORY="%SERVER_DIRECTORY%"
...
call msiexec /x "bin\${final.artifact.name}.msi" /qn /l*v uninstall.log
