...
if __name__ == '__main__':
    os.system(r'heat dir ..\..\appserver\setup\build\exe.win32-2.7 -wixvar -nologo -sfrag -suid -sreg -ag -srd -dir WebHelp -out AppServerFiles.wxs -cg AppServerFilesComponent -dr ${installer.customization}AppServerDir -var var.AppServerSourceDir -wixvar')
    fixasfiles()