...
if __name__ == '__main__':
    os.system(r'heat dir ${AppServerDir} -wixvar -nologo -sfrag -suid -sreg -ag -srd -dir WebHelp -out AppServerFiles.wxs -cg AppServerFilesComponent -dr ${customization}AppServerDir -var var.AppServerSourceDir -wixvar')
    fixasfiles()