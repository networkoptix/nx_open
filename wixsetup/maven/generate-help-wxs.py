...
if __name__ == '__main__':
    os.system(r'heat dir ${ClientHelpSourceDir} -wixvar -nologo -sfrag -suid -sreg -ag -srd -dir WebHelp -out ClientHelp.wxs -cg ClientHelpComponent -dr ${customization}HelpDir -var var.ClientHelpSourceDir')
    fixasfiles()