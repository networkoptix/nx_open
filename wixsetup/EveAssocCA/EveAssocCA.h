...
// This class is exported from the EveAssocCA.dll
class EVEASSOCCA_API CEveAssocCA {
public:
	CEveAssocCA(void);
	// TODO: add your methods here.
};

extern EVEASSOCCA_API int nEveAssocCA;

EVEASSOCCA_API int fnEveAssocCA(void);
