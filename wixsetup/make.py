...
os.system(r'light -cultures:en-US -ext WixFirewallExtension.dll -ext WixUIExtension.dll -ext WixUtilExtension.dll -out %s -pdbout bin\Release\EVEMediaPlayerSetup.wixpdb obj\Release\*.wixobj' % output_file)
