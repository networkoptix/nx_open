...
/************************************************************************/
/* Checking layout tours access                                         */
/************************************************************************/

// Autogenerated layout in a tour is accessible - tour first
TEST_F(QnResourceAccessManagerTest, checkAutogeneratedLayoutInTour1)
{
    loginAs(Qn::NoGlobalPermissions);

    ec2::ApiLayoutTourData tour;
    tour.id = QnUuid::createUuid();
    tour.parentId = m_currentUser->getId();
    layoutTourManager()->addOrUpdateTour(tour);

    auto layout = createLayout(Qn::remote, false, tour.id);
    resourcePool()->addResource(layout);
...
// Autogenerated layout in a tour is accessible - layout first
TEST_F(QnResourceAccessManagerTest, checkAutogeneratedLayoutInTour2)
{
    loginAs(Qn::NoGlobalPermissions);
...
// Autogenerated layout on other user's tour
TEST_F(QnResourceAccessManagerTest, checkAutogeneratedLayoutInOtherTour)
{
    loginAs(Qn::NoGlobalPermissions);
...
TEST_F(QnResourceAccessManagerTest, canCreateLayoutInOwnTour)
{
    loginAs(Qn::NoGlobalPermissions);
    ...
    auto layout = createLayout(Qn::remote, false, tour.id);
    ASSERT_TRUE(resourceAccessManager()->canCreateLayout(m_currentUser, layout->getParentId()));
}

TEST_F(QnResourceAccessManagerTest, canCreateLayoutInOtherTour)
{
    loginAs(Qn::NoGlobalPermissions);
    ...
    auto layout = createLayout(Qn::remote, false, tour.id);
    ASSERT_FALSE(resourceAccessManager()->canCreateLayout(m_currentUser, layout->getParentId()));
}
