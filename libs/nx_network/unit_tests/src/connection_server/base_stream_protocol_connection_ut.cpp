...
protected:
    ...
    {
        ASSERT_NE(SystemError::noError, m_connectionClosedEvents.pop());
    }
...
private:
    ...
    void saveConnectionClosedEvent(SystemError::ErrorCode systemErrorCode)
    {
        m_connectionClosedEvents.push(systemErrorCode);
    }
};
