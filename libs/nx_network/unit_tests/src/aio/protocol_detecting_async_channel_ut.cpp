...
protected:
    ...
    void whenReceiveRandomBytes()
    {
        ...
        m_rawDataSource.write(randomBytes.data(), randomBytes.size());
    ...
    void whenReceiveSomeProtocolHeader()
    {
        ...
        m_dataSent += selectedProtocolHeader;
