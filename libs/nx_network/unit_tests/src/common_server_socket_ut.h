...
TYPED_TEST_SUITE_P(ServerSocketTest);
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(ServerSocketTest);
REGISTER_TYPED_TEST_SUITE_P(ServerSocketTest, accept_async_on_blocking_socket_results_in_error);
