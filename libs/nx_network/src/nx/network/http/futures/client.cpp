...
cf::future<Response> Client::post(const Url& url, const std::string& contentType, nx::Buffer requestBody)
{
...
cf::future<Response> Client::put(const Url& url, const std::string& contentType, nx::Buffer requestBody)
{
...
cf::future<Response> Client::upgrade(const Url& url, const std::string& targetProtocol)
{
...
cf::future<Response> Client::connect(const Url& url, const std::string& targetHost)
{
    return futurize(NX_WRAP_MEM_FUNC_TO_LAMBDA(doConnect), this, url, targetHost);
}

cf::future<Response> Client::request(Method method, const Url& url)
{
