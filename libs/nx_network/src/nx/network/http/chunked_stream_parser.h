...
public:
     ...
     * TODO: #akolesnikov Make it non-template and move to cpp.
     */
    template<class Func>
    size_t parse(
        ...
        Func func)
    {
        // TODO: #akolesnikov Split this function after it is merged to the cloud_backend branch.
        ...
        for (; currentOffset < data.size(); )
        {
            ...
            switch (m_chunkStreamParseState)
            {
                ...
                case State::readingChunkExtension:
                    // TODO: #akolesnikov Reading extension.
                ...
                case State::readingChunkData:
                {
                    ...
                    func(data.substr(currentOffset, bytesToCopy));
                ...
                case State::readingTrailer:
                {
                    ...
                    // TODO #akolesnikov Parsing entity-header.
                    break;
                }
