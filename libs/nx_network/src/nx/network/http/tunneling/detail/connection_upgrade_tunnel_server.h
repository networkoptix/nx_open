...
public:
    ...
    void setUpgradeRequestMethod(const Method& method);
    Method upgradeRequestMethod() const;

private:
    std::string m_protocolToUpgradeTo = kConnectionUpgradeTunnelProtocol;
    Method m_upgradeRequestMethod = std::string_view(kConnectionUpgradeTunnelMethod);
...
template<typename ...ApplicationData>
Method ConnectionUpgradeTunnelServer<ApplicationData...>::upgradeRequestMethod() const
{
