    ...
    ConnectCompletionHandler completionHandler)
{
    ...
    NX_VERBOSE(this, nx::format("cross-nat %1. Notifying host %2 on connection choice")
    ...
    SystemError::ErrorCode errorCode)
{
    ...
    NX_VERBOSE(this, nx::format("cross-nat %1 completed. result: %2")
    ...
    // from this class.
    m_requestPipeline->serializer().setAlwaysAddFingerprint(false);
    ...
    nx::network::stun::Message message)
{
    ...
    {
        NX_DEBUG(this, nx::format("cross-nat %1. Received error instead of syn-ack from %2")
    ...
    switch (message.header.method)
    {
        ...
        default:
            NX_VERBOSE(this, nx::format("cross-nat %1. Received unexpected message %2 from %3. Ignoring...")
    ...
    nx::network::stun::Message message)
{
    ...
    {
        NX_DEBUG(this, nx::format("cross-nat %1. Error parsing syn-ack from %2: %3")
            .arg(connectSessionId()).arg(remoteAddress().toString())
    ...
    {
        NX_DEBUG(this, nx::format("cross-nat %1. Error. Unexpected connection id (%2) in syn-ack from %3")
    ...
    nx::network::stun::Message message)
{
    ...
    {
        NX_DEBUG(this, nx::format("cross-nat %1. Error parsing TunnelConnectionChosenResponse from %2: %3")
            .arg(connectSessionId()).arg(remoteAddress().toString())
...
{
    NX_DEBUG(this, nx::format("cross-nat %1. Error. %2 timeout has expired while waiting for %3")
