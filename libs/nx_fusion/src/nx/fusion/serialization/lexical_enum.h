...
QN_DEFINE_EXPLICIT_ENUM_LEXICAL_FUNCTIONS(/* empty scope */, ENUM, ELEMENTS, ##__VA_ARGS__)
 ...
 */
#define QN_DEFINE_EXPLICIT_ENUM_LEXICAL_FUNCTIONS(SCOPE, ENUM, ELEMENTS, ... /* PREFIX */)  \
    QN_DEFINE_EXPLICIT_ENUM_LEXICAL_SERIALIZER_FACTORY_FUNCTION(SCOPE::ENUM, ELEMENTS, ##__VA_ARGS__) \
 ...
 * \internal
 */
#define QN_DEFINE_FACTORY_ENUM_LEXICAL_FUNCTIONS(SCOPE, ENUM, ... /* PREFIX */)  \
    QN_DEFINE_FACTORY_ENUM_LEXICAL_FUNCTIONS_I(SCOPE::ENUM, BOOST_PP_CAT(BOOST_PP_CAT(qn_enumLexicalSerializerData_instance, ENUM), __LINE__), ##__VA_ARGS__)
