...
template<class T>
T deserialized(const nx::ConstBufferRefType& value, const T& defaultValue = T(), bool* success = nullptr);

template<class T>
T deserialized(const char* value, const T& defaultValue = T(), bool* success = nullptr);
