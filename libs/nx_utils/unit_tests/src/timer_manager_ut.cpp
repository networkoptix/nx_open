...
TEST(parseTimerDuration, correct_input)
{
    ...
    ASSERT_EQ(seconds(1), parseTimerDuration(std::string_view("1s"), defaultValue));
    ASSERT_EQ(seconds(1), parseTimerDuration(std::string_view("1000ms"), defaultValue));
    ASSERT_EQ(hours(1), parseTimerDuration(std::string_view("1h"), defaultValue));
    ASSERT_EQ(hours(24), parseTimerDuration(std::string_view("1d"), defaultValue));
    ASSERT_EQ(seconds(0), parseTimerDuration(std::string_view("0s"), defaultValue));
}
...
TEST(parseTimerDuration, incorrect_input)
{
    ...
    ASSERT_EQ(defaultValue, parseTimerDuration(std::string_view("s"), defaultValue));
    ASSERT_EQ(defaultValue, parseTimerDuration(std::string_view(), defaultValue));
}
