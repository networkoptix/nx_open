...
{
    {
        ...
        nx::utils::BitStreamWriter writer(data, data + 2);
...

    {
        ...
        nx::utils::BitStreamWriter writer(data, data + 4);
...
{
    {
        ...
        nx::utils::BitStreamReader reader(data, data + sizeof(data));
...
{
    {
        const int size = 2;
        uint8_t data[size];
        nx::utils::BitStreamWriter writer(data, data + size);
