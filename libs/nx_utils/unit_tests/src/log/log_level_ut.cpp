...
{
    ASSERT_EQ(Level::undefined, levelFromString("unknown value"));
    ...
    ASSERT_EQ(Level::trace, levelFromString("trace"));
    ASSERT_EQ(Level::trace, levelFromString("TRACE"));
    ASSERT_EQ(Level::trace, levelFromString("t"));
...
TEST(LogLevel, ToString)
{
    ...
    ASSERT_EQ("trace", toString(Level::trace));
