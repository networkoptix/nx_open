...
public:
    ...
    virtual bool processData(const ConstBufferRefType& data)
    {
        // TODO: #akolesnikov Add support of functor with return value.
        m_func(data);
        return true;
    }
...
nx::Buffer runBytesThroughFilter(const nx::Buffer& data)
{
    nx::Buffer result;
