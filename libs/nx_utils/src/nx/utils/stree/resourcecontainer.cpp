...
void ResourceContainer::put(int resID, const std::string_view& value)
{
    m_mediaStreamPameters[resID] = QString::fromUtf8(value.data(), value.size());
}

void ResourceContainer::put(int resID, const char* value)
{
    m_mediaStreamPameters[resID] = QString::fromUtf8(value);
}
