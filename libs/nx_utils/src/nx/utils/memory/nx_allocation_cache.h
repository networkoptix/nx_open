 ...
 * NOTE: This class is intended to be used for allocating relatively large buffers (e.g., video packets).
 */
class NX_UTILS_API NxBufferCache
{
public:
    /**
     * When searching for an existing buffer, buffer with size MAX_BUFFER_SIZE_EXCESS_PERCENT
     * percent greater than requested will do.
     */
