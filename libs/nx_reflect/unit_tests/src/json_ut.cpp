...
void deserializationFailed(
    const std::string& wrongJson, const DeserializationResult& error)
{
    ...
    ASSERT_EQ(
        std::tie(
            ...
            deserialized.errorDescription,
            deserialized.firstBadFragment,
            deserialized.firstNonDeserializedField),
        (std::tie(
            error.success,
            error.errorDescription,
            error.firstBadFragment,
            error.firstNonDeserializedField)));
}
...
TEST_F(Json, error_reporting)
{
    ...
    deserializationFailed<FooBuiltInTypes>(
        ...
        DeserializationResult(
            false,
            "Either an object or an array is expected as a json object",
            "\"not an object\""));
