...
// SPS with VUI present but bitstream_restriction_flag=0.
// min_spatial_segmentation_idc must default to 0, not be left uninitialized.
TEST(H265, SpsParseNoBitstreamRestriction)
{
    uint8_t data[] = {
    ...
    ASSERT_EQ(sps.vui_parameters.bitstream_restriction_flag, 0);
    ASSERT_EQ(sps.vui_parameters.min_spatial_segmentation_idc, 0);
}
