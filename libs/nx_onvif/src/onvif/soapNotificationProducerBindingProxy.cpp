...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(struct soap *_soap, const char *soap_endpoint_url)
{
    this->soap = _soap;
    this->soap_own = false;
    NotificationProducerBindingProxy_init(_soap->imode, _soap->omode);
...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const char *soap_endpoint_url)
{
    this->soap = soap_new();
    this->soap_own = true;
    NotificationProducerBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const char *soap_endpoint_url, soap_mode iomode)
{
    this->soap = soap_new();
    this->soap_own = true;
    NotificationProducerBindingProxy_init(iomode, iomode);
...
const char *NotificationProducerBindingProxy::soap_fault_subcode()
{
...
int NotificationProducerBindingProxy::send_Subscribe(const char *soap_endpoint_url, const char *soap_action, _wsnt__Subscribe *wsnt__Subscribe)
{
    ...
    soap_tmp___onvifEvents_npb__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
    soap_begin(soap);
...
int NotificationProducerBindingProxy::recv_Subscribe(_wsnt__SubscribeResponse &wsnt__SubscribeResponse)
{
...
int NotificationProducerBindingProxy::send_GetCurrentMessage(const char *soap_endpoint_url, const char *soap_action, _wsnt__GetCurrentMessage *wsnt__GetCurrentMessage)
{
    ...
    soap_tmp___onvifEvents_npb__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
    soap_begin(soap);
    soap->encodingStyle = NULL; /* use SOAP literal style */
    soap_serializeheader(soap);
...
int NotificationProducerBindingProxy::recv_GetCurrentMessage(_wsnt__GetCurrentMessageResponse &wsnt__GetCurrentMessageResponse)
{
