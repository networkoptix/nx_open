...
#include "soapH.h"
    ...
    class SOAP_CMAC AdvancedSecurityServiceBindingService {
      public:
        ...
        virtual int GetServiceCapabilities(_onvifAdvancedSecurity__GetServiceCapabilities *onvifAdvancedSecurity__GetServiceCapabilities, _onvifAdvancedSecurity__GetServiceCapabilitiesResponse &onvifAdvancedSecurity__GetServiceCapabilitiesResponse) SOAP_PURE_VIRTUAL;
    };
#endif
