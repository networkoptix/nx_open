...
int PullPointSubscriptionBindingProxy::send_PullMessages(const char *soap_endpoint_url, const char *soap_action, _onvifEvents__PullMessages *onvifEvents__PullMessages)
{
...
int PullPointSubscriptionBindingProxy::recv_PullMessages(_onvifEvents__PullMessagesResponse &onvifEvents__PullMessagesResponse)
{
...
int PullPointSubscriptionBindingProxy::send_Seek(const char *soap_endpoint_url, const char *soap_action, _onvifEvents__Seek *onvifEvents__Seek)
{
...
int PullPointSubscriptionBindingProxy::recv_Seek(_onvifEvents__SeekResponse &onvifEvents__SeekResponse)
{
...
int PullPointSubscriptionBindingProxy::send_SetSynchronizationPoint(const char *soap_endpoint_url, const char *soap_action, _onvifEvents__SetSynchronizationPoint *onvifEvents__SetSynchronizationPoint)
{
...
int PullPointSubscriptionBindingProxy::recv_SetSynchronizationPoint(_onvifEvents__SetSynchronizationPointResponse &onvifEvents__SetSynchronizationPointResponse)
{
...
int PullPointSubscriptionBindingProxy::send_Unsubscribe(const char *soap_endpoint_url, const char *soap_action, _wsnt__Unsubscribe *wsnt__Unsubscribe)
{
    ...
    soap_tmp___onvifEvents_pps__Unsubscribe.wsnt__Unsubscribe = wsnt__Unsubscribe;
    soap_begin(soap);
    soap->encodingStyle = NULL; /* use SOAP literal style */
    soap_serializeheader(soap);
