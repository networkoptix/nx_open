...
#include "soapH.h"
    ...
    class SOAP_CMAC NotificationConsumerBindingService {
      public:
        ...
        /// Copy constructor
        NotificationConsumerBindingService(const NotificationConsumerBindingService&);
        /// Construct service given a shared managing context
        NotificationConsumerBindingService(struct soap*);
        ...
        virtual NotificationConsumerBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        NotificationConsumerBindingService& operator=(const NotificationConsumerBindingService&);
