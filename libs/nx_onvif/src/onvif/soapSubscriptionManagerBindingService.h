...
#include "soapH.h"
    ...
    class SOAP_CMAC SubscriptionManagerBindingService {
      public:
        ...
        /// Copy constructor
        SubscriptionManagerBindingService(const SubscriptionManagerBindingService&);
        /// Construct service given a shared managing context
        SubscriptionManagerBindingService(struct soap*);
        ...
        virtual SubscriptionManagerBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        SubscriptionManagerBindingService& operator=(const SubscriptionManagerBindingService&);
