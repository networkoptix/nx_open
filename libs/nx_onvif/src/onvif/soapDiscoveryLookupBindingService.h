...
#include "soapH.h"
    ...
    class SOAP_CMAC DiscoveryLookupBindingService {
      public:
        ...
        /// Copy constructor
        DiscoveryLookupBindingService(const DiscoveryLookupBindingService&);
        /// Construct service given a shared managing context
        DiscoveryLookupBindingService(struct soap*);
        ...
        virtual DiscoveryLookupBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        DiscoveryLookupBindingService& operator=(const DiscoveryLookupBindingService&);
        ...
        virtual int Probe(const struct wsdd__ProbeType& onvifNetwork__Probe, struct wsdd__ProbeMatchesType &onvifNetwork__ProbeResponse) SOAP_PURE_VIRTUAL;
    };
#endif
