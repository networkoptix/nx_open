...
int RemoteDiscoveryBindingProxy::send_Hello(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__HelloType& onvifNetwork__Hello)
{
...
int RemoteDiscoveryBindingProxy::recv_Hello(struct wsdd__ResolveType &onvifNetwork__HelloResponse)
{
...
int RemoteDiscoveryBindingProxy::send_Bye(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__ByeType& onvifNetwork__Bye)
{
...
int RemoteDiscoveryBindingProxy::recv_Bye(struct wsdd__ResolveType &onvifNetwork__ByeResponse)
{
