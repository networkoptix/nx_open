...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(struct soap *_soap, const char *soap_endpoint_url)
{
    this->soap = _soap;
    this->soap_own = false;
    CreatePullPointBindingProxy_init(_soap->imode, _soap->omode);
...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(const char *soap_endpoint_url)
{
    this->soap = soap_new();
    this->soap_own = true;
    CreatePullPointBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(const char *soap_endpoint_url, soap_mode iomode)
{
    this->soap = soap_new();
    this->soap_own = true;
    CreatePullPointBindingProxy_init(iomode, iomode);
...
const char *CreatePullPointBindingProxy::soap_fault_subcode()
{
...
int CreatePullPointBindingProxy::send_CreatePullPoint(const char *soap_endpoint_url, const char *soap_action, _wsnt__CreatePullPoint *wsnt__CreatePullPoint)
{
    ...
    soap_tmp___onvifEvents_cpb__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
    soap_begin(soap);
...
int CreatePullPointBindingProxy::recv_CreatePullPoint(_wsnt__CreatePullPointResponse &wsnt__CreatePullPointResponse)
{
