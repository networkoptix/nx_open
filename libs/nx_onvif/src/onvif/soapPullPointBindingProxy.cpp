...
PullPointBindingProxy::PullPointBindingProxy(struct soap *_soap, const char *soap_endpoint_url)
{
    this->soap = _soap;
    this->soap_own = false;
    PullPointBindingProxy_init(_soap->imode, _soap->omode);
...
PullPointBindingProxy::PullPointBindingProxy(const char *soap_endpoint_url)
{
    this->soap = soap_new();
    this->soap_own = true;
    PullPointBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
PullPointBindingProxy::PullPointBindingProxy(const char *soap_endpoint_url, soap_mode iomode)
{
    this->soap = soap_new();
    this->soap_own = true;
    PullPointBindingProxy_init(iomode, iomode);
...
const char *PullPointBindingProxy::soap_fault_subcode()
{
...
int PullPointBindingProxy::send_GetMessages(const char *soap_endpoint_url, const char *soap_action, _wsnt__GetMessages *wsnt__GetMessages)
{
    ...
    soap_tmp___onvifEvents_ppb__GetMessages.wsnt__GetMessages = wsnt__GetMessages;
    soap_begin(soap);
...
int PullPointBindingProxy::recv_GetMessages(_wsnt__GetMessagesResponse &wsnt__GetMessagesResponse)
{
...
int PullPointBindingProxy::send_DestroyPullPoint(const char *soap_endpoint_url, const char *soap_action, _wsnt__DestroyPullPoint *wsnt__DestroyPullPoint)
{
    ...
    soap_tmp___onvifEvents_ppb__DestroyPullPoint.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
    soap_begin(soap);
    soap->encodingStyle = NULL; /* use SOAP literal style */
    soap_serializeheader(soap);
...
int PullPointBindingProxy::recv_DestroyPullPoint(_wsnt__DestroyPullPointResponse &wsnt__DestroyPullPointResponse)
{
...
int PullPointBindingProxy::send_Notify(const char *soap_endpoint_url, const char *soap_action, _wsnt__Notify *wsnt__Notify)
{
    ...
    soap_tmp___onvifEvents_ppb__Notify.wsnt__Notify = wsnt__Notify;
    soap_begin(soap);
    soap->encodingStyle = NULL; /* use SOAP literal style */
    soap_serializeheader(soap);
