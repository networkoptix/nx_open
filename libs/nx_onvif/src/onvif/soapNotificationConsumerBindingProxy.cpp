...
NotificationConsumerBindingProxy::NotificationConsumerBindingProxy(const char *endpoint)
{
    this->soap = soap_new();
    this->soap_own = true;
    NotificationConsumerBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
NotificationConsumerBindingProxy::NotificationConsumerBindingProxy(const char *endpoint, soap_mode iomode)
{
    this->soap = soap_new();
    this->soap_own = true;
    NotificationConsumerBindingProxy_init(iomode, iomode);
...
int NotificationConsumerBindingProxy::send_Notify(const char *endpoint, const char *soap_action, _oasisWsnB2__Notify *oasisWsnB2__Notify)
{
    ...
    soap_tmp___onvifEvents_ncb__Notify.oasisWsnB2__Notify = oasisWsnB2__Notify;
    soap_begin(soap);
