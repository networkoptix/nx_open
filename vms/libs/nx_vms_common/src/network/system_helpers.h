...
NX_VMS_COMMON_API nx::Uuid currentSystemLocalId(const nx::vms::common::SystemSettings* globalSettings);

NX_VMS_COMMON_API bool currentSystemIsNew(const nx::vms::common::SystemSettings* globalSettings);
