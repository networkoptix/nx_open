...
LicenseUsageWatcher::LicenseUsageWatcher(QnCommonModule* context, QObject* parent):
    base_type(parent),
    QnCommonModuleAware(context)
{
...
DeviceLicenseUsageWatcher::DeviceLicenseUsageWatcher(QnCommonModule* context, QObject* parent):
    base_type(context, parent)
{
    ...
    auto connectToCamera =
        ...
        {
            connect(camera.get(), &QnVirtualCameraResource::licenseUsedChanged, this,
                &LicenseUsageWatcher::licenseUsageChanged);
