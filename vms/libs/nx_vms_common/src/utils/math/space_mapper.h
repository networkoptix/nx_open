...
public:
    ...
    QnScalarInterpolationSpaceMapper(const QList<QPair<qreal, qreal> > &sourceToTarget, Qn::ExtrapolationMode extrapolationMode) {
        init(sourceToTarget, extrapolationMode);
    }
...
private:
    void init(const QList<QPair<qreal, qreal> > &sourceToTarget, Qn::ExtrapolationMode extrapolationMode) {
        QList<QPair<qreal, qreal> > targetToSource;
