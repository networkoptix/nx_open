...
#include <utils/media/hevc/profile_tier_level.h>
#include <utils/media/hevc/scaling_list_data.h>
#include <utils/media/hevc/short_term_reference_picture_set.h>
#include <utils/media/hevc/video_usability_information_parameters.h>
...
struct NX_VMS_COMMON_API SequenceParameterSet
{
public:
