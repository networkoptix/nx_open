...
struct NX_VMS_COMMON_API HRDParameters
{
    bool read(BitStreamReader& reader, bool commonInfPresentFlag, uint8_t maxNumSubLayersMinus1);

    struct SubLayerHRDParameters
    {
        struct Data
        {
            void read(BitStreamReader& reader, bool sub_pic_hrd_params_present_flag);
