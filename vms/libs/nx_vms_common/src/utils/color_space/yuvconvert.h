...
NX_VMS_COMMON_API void yuv444_argb32_simd_intr(unsigned char * dst, const unsigned char * py,
...
/** ATTENTION: Despite its name, this function actually converts to BGRA. */
NX_VMS_COMMON_API void yuv422_argb32_simd_intr(unsigned char * dst, const unsigned char * py,
                            const unsigned char * pu, const unsigned char * pv,
                            const unsigned int width, const unsigned int height,
                            const unsigned int dst_stride, const unsigned int y_stride,
                            const unsigned int uv_stride, quint8 alpha);
...
/** ATTENTION: Despite its name, this function actually converts to BGRA. */
NX_VMS_COMMON_API void yuv420_argb32_simd_intr(unsigned char * dst, const unsigned char * py,
                            const unsigned char * pu, const unsigned char * pv,
                            const unsigned int width, const unsigned int height,
                            const unsigned int dst_stride, const unsigned int y_stride,
                            const unsigned int uv_stride, quint8 alpha);

NX_VMS_COMMON_API void bgra_yuv420(
...
*/
NX_VMS_COMMON_API void bgra_to_yv12_simd_intr(
...
/*!
    ...
    \param uvStride Line length in \a u and \a v buffers
*/
NX_VMS_COMMON_API void bgra_to_yva12_simd_intr(
