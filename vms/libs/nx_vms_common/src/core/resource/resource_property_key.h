...
NX_VMS_API extern  const QString kAvailableProfiles;
NX_VMS_API extern  const QString kForcedPrimaryProfile;
NX_VMS_API extern  const QString kForcedSecondaryProfile;
...
NX_VMS_API extern const QString kCameraHotspotsData;
 ...
 */
NX_VMS_API extern const QString kRemoteArchiveSynchronizationMode;

/**
 * Whether manual remote archive import is triggered.
 */
NX_VMS_API extern const QString kManualRemoteArchiveSynchronizationTriggered;
...
NX_VMS_API extern const QString kAnalogEncoder;
...
NX_VMS_API extern const QString kDisableRtspMetadataStream;
