...
{
    QByteArray result;
    result.append(magic.toString().toUtf8()).append(CSV_DELIMITER);             // magic
    result.append(QByteArray::number(version)).append(CSV_DELIMITER);  // protocol version
    result.append(requestId.toString().toUtf8()).append(CSV_DELIMITER);         // request ID
    result.append(clientId.toString().toUtf8()).append(CSV_DELIMITER);          // client ID
    result.append(serverId.toString().toUtf8()).append(CSV_DELIMITER);          // server ID
