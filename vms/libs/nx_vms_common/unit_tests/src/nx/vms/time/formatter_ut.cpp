...
TEST(FormatterTest, fromNow)
{
    ...
    EXPECT_EQ("1 minutes ago", fromNow(60s));
    EXPECT_EQ("2 minutes ago", fromNow(125s));

    EXPECT_EQ("59 minutes ago", fromNow(59min));
    EXPECT_EQ("1 hours ago", fromNow(60min));
    EXPECT_EQ("23 hours ago", fromNow(23h + 10min));

    EXPECT_EQ("yesterday", fromNow(24h));
    EXPECT_EQ("yesterday", fromNow(47h));
    EXPECT_EQ("2 days ago", fromNow(49h));
    EXPECT_EQ("6 days ago", fromNow(24h * 6 + 10h));

    EXPECT_EQ("a week ago", fromNow(24h * 7 + 1h));

    EXPECT_EQ("10000000 days ago", fromNow(24h * 10000000)); //< ~27397 years ago, incorrect time.
