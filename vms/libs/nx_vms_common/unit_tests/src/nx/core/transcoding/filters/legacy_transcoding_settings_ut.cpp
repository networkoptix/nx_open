...
{
    params.insert("id", "89abcdef-0123-4567-89ab-cdef01234567");
    ...
    if (!settings.isValid())
    {
        EXPECT_EQ("invalidSettings", expectedError);
        return;
    }
...
TEST(LegacyTranscodingSettings, streamInvalid)
{
    ...
    }
    {
        ...
        QnLegacyTranscodingSettings settings;
        settings.resource = resource;
        checkResourceAndJson(resource, params, settings, "invalidSettings");
    }
}
