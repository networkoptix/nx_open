...
class CachedSharedLayoutItemAccessProviderTest: public CachedBaseAccessProviderTestFixture
{
protected:
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, checkInvalidAccess)
{
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, checkAccessToInvalidResource)
{
    auto user = addUser(GlobalPermission::admin);
    ASSERT_FALSE(accessProvider()->hasAccess(user, QnResourcePtr()));
}

TEST_F(CachedSharedLayoutItemAccessProviderTest, checkDefaultCamera)
{
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, checkSharedCamera)
{
    auto target = addCamera();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, checkSource)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, checkSharedServer)
{
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutMadeShared)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutStopSharing)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutItemAdded)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutItemRemoved)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutAdded)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, layoutRemoved)
{
    auto target = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
...
TEST_F(CachedSharedLayoutItemAccessProviderTest, accessProviders)
{
    auto camera = addCamera();
    auto user = addUser(GlobalPermission::none);
    auto layout = addLayout();
