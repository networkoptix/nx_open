...
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(
    AttributeDescriptionCommon, (json), AttributeDescriptionCommon_Fields, (brief, true))
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(
    DependentAttributeDescription, (json), DependentAttributeDescription_Fields, (brief, true))
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(
