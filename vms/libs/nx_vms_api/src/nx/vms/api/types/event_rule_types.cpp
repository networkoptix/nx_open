...
QN_FUSION_DEFINE_FUNCTIONS(nx::vms::api::PredefinedPluginEventType, (numeric)(debug))
QN_DEFINE_EXPLICIT_ENUM_LEXICAL_FUNCTIONS(nx::vms::api, PredefinedPluginEventType,
    (nx::vms::api::PredefinedPluginEventType::undefined, "")
    (
        nx::vms::api::PredefinedPluginEventType::nullDeviceAgent,
        "nullDeviceAgent"
    )
    (
        nx::vms::api::PredefinedPluginEventType::nullDeviceAgentManifest,
        "nullDeviceAgentManifest"
    )
    (
        nx::vms::api::PredefinedPluginEventType::nullDeviceAgentManifestString,
        "nullDeviceAgentManifestString"
    )
    (
        nx::vms::api::PredefinedPluginEventType::emptyDeviceAgentManifestString,
        "emptyDeviceAgentManifestString"
    )
    (
        nx::vms::api::PredefinedPluginEventType::nullEngine,
        "nullEngine"
    )
    (
        nx::vms::api::PredefinedPluginEventType::nullEngineManifest,
        "nullEngineManifest"
    )
    (
        nx::vms::api::PredefinedPluginEventType::nullEngineManifestString,
        "nullEngineManifestString"
    )
    (
        nx::vms::api::PredefinedPluginEventType::emptyEngineManifestString,
