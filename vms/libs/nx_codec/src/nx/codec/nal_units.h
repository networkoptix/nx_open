...
public:
    ...
    */
    ...
    static void writeUEGolombCode(nx::utils::BitStreamWriter& bitWriter, quint32 value);
    void writeSEGolombCode(nx::utils::BitStreamWriter& bitWriter, qint32 value);
    const nx::utils::BitStreamReader& getBitReader() const {return bitReader;}
    static void write_rbsp_trailing_bits(nx::utils::BitStreamWriter& writer);
    static void write_byte_align_bits(nx::utils::BitStreamWriter& writer);
...
class NX_CODEC_API SPSUnit: public NALUnit
{
public:
    int profile_idc;
...
class NX_CODEC_API SEIUnit: public NALUnit {
public:
    ...
    void serialize_pic_timing_message(const SPSUnit& sps, nx::utils::BitStreamWriter& writer, bool seiHeader);
    void serialize_buffering_period_message(const SPSUnit& sps, nx::utils::BitStreamWriter& writer, bool seiHeader);
...
class NX_CODEC_API SliceUnit: public NALUnit
{
public:
    ...
    int serializeSliceHeader(nx::utils::BitStreamWriter& bitWriter, const QMap<quint32, SPSUnit*>& spsMap,
