...
public:
    ...
    const nx::utils::BitStreamReader& getBitReader() {return bitReader;}
...
class NX_CODEC_API VC1SequenceHeader: public VC1Unit {
public:
...
class NX_CODEC_API VC1Frame: public VC1Unit {
public:
