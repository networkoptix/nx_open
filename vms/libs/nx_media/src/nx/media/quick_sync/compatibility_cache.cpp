...
bool CompatibilityCache::isCompatibleCached(AVCodecID codec, int width, int height)
{
    ...
    bool isCompatible = tryCompatibility(codec, width, height);
    if (isCompatible)
...
bool CompatibilityCache::tryCompatibility(AVCodecID codec, int width, int height)
{
    mfxVideoParam param;
