...
/*!
    ...
    - \a nxcip::CameraDiscoveryManager. Mandatory. Used to discover camera and instantiate \a nxcip::BaseCameraManager
    ...
    public:
        ...
        */
        ...
        /*!
            ...
            \param[out] cameras Array of size \a CAMERA_INFO_ARRAY_SIZE. Implementation fills this array with found camera(s) information
...
#undef PACKED
    ...
    public:
        ...
        */
        ...
        /*!
            \param[out] codec
            \param[out] pixelFormat NOTE: Uncompressed video from a camera is not supported by the
                Server, thus the values AV_PIX_FMT_RGB24, AV_PIX_FMT_BGRA and AV_PIX_FMT_RGBA
                cannot be used.
            \return \a nxcip::NX_NO_ERROR on success, otherwise - error code
    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
            Required period detalization level.
    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
            \param paramName \0-terminated utf-8 string specifying unique id of the parameter.
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
         * @return Any valid video or audio codec. The values AV_CODEC_ID_NONE, AV_CODEC_ID_TEXT
         *     and AV_CODEC_ID_BIN_DATA are currently not supported. Uncompressed video formats
    ...
    // {A3F5D1BA-5A74-42BD-8890-A1C6E0197C04}
    static const nxpl::NX_GUID IID_Encryptable = { { 0xa3, 0xf5, 0xd1, 0xba, 0x5a, 0x74, 0x42, 0xbd, 0x88, 0x90, 0xa1, 0xc6, 0xe0, 0x19, 0x7c, 0x4  } };

    /**
    * Mix-in. Media packet implementation classes may inherit from this class along with some
    * interface of MediaDataPacket family. Encryption data is opaque data which plugin should
    * store and return back but not use in any way.
    */
    class Encryptable
    {
    public:
    ...
    */
    ...
    public:
        ...
        /*!
            ...
            \note If two subsequent packets has timestamp difference greater than 2 seconds it is considered that timestamp discontinuity has occurred
    ...
    public:
        enum Capabilities
        {
            ...
            */
            ...
            /*!
                \note This functionality is optional. Helps for better performance
            */
        ...
        */
        ...
        /*!
            ...
            \note This functionality is required
        */
        virtual int seek(
            unsigned int cSeq,
        ...
        /*!
            ...
            \return \a NX_NO_ERROR on success, otherwise - error code
            \note This functionality is optional
