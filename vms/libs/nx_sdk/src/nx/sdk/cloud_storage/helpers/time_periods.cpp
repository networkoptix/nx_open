...
TimePeriods::TimePeriods(const std::vector<nx::sdk::cloud_storage::TimePeriod>& periods)
{
    setPeriods(periods);
}
...
void TimePeriods::setPeriods(const std::vector<nx::sdk::cloud_storage::TimePeriod>& periods)
{
    m_periods = periods;
    m_it = m_periods.cbegin();
}
