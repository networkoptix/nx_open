...
TEST(MediaContextSerializableData, main)
{
    ...
    data.codedWidth = 2048;
    data.codedHeight = 1200;
    data.width = 1920;
    data.height = 1080;
    ...
    static const std::vector<uint8_t> expectedData{
        0x5B,0x6C,0x00,0x00,0x00,0x1C,0x6C,0x00,0x00,0x00,0x00,0x5B,0x24,0x55,0x23,0x55,
        0x00,0x5B,0x24,0x55,0x23,0x55,0x00,0x5B,0x23,0x55,0x00,0x5B,0x23,0x55,0x00,0x5B,
        0x23,0x55,0x00,0x6C,0x00,0x00,0x00,0x00,0x6C,0x00,0x00,0x00,0x00,0x6C,0x00,0x00,
        0x00,0x00,0x6C,0x00,0x00,0x00,0x08,0x6C,0x00,0x00,0x08,0x00,0x6C,0x00,0x00,0x04,
        0xB0,0x6C,0x00,0x00,0x07,0x80,0x6C,0x00,0x00,0x04,0x38,0x6C,0x04,0xC4,0xB4,0x00,
        0x4C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x2A,0x6C,0x00,0x00,0x00,0x20,0x5D
    };
    ...
    ASSERT_EQ(data.codedWidth, deserialized.codedWidth);
    ASSERT_EQ(data.codedHeight, deserialized.codedHeight);
