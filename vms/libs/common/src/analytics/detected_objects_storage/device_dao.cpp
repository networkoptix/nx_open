...
long long DeviceDao::deviceIdFromGuid(const QnUuid& deviceGuid) const
{
    QnMutexLocker locker(&m_mutex);
...
QnUuid DeviceDao::deviceGuidFromId(long long id) const
{
    QnMutexLocker locker(&m_mutex);
...
long long DeviceDao::insertOrFetch(
