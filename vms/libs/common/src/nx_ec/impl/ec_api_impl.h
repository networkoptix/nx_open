...
// TODO #ak Defining multiple handler macro because vs2012 does not support variadic templates.
...
#define DEFINE_ONE_ARG_HANDLER(REQUEST_NAME, FIRST_ARG_TYPE)                                       \
    ...
    {                                                                                              \
    public:                                                                                        \
        Custom##REQUEST_NAME##Handler(                                                             \
            TargetType* target,                                                                    \
            HandlerType func,                                                                      \
            Qt::ConnectionType connectionType = Qt::AutoConnection)                                \
        {                                                                                          \
            QObject::connect(                                                                      \
                static_cast<AppServerSignaller*>(this),                                            \
                &AppServerSignaller::on##REQUEST_NAME##Done,                                       \
                target, func, connectionType);                                                     \
        }                                                                                          \
                                                                                                   \
        virtual void done(int reqID, const FIRST_ARG_TYPE& val1) override                          \
        {                                                                                          \
            on##REQUEST_NAME##Done(reqID, val1);                                                   \
        }                                                                                          \
    };
