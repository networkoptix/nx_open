...
template<> QnSystemsWeightsManager* Singleton<QnSystemsWeightsManager>::s_instance = nullptr;
...
void QnSystemsWeightsManager::addLocalWeightData(const nx::vms::client::core::WeightData& data)
{
    ...
    qreal weight)
{
    ...
    const auto it = std::find_if(localWeights.begin(), localWeights.end(),
        [localSystemId](const nx::vms::client::core::WeightData& data)
        {
    ...
    {
        localWeights.append(nx::vms::client::core::WeightData({
