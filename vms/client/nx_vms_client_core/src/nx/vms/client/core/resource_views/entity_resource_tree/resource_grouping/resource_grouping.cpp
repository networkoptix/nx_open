...
{
    using nx::vms::client::core::entity_resource_tree::resource_grouping::kSubIdDelimiter;
...
class ResourceGroupingStrings
{
    Q_DECLARE_TR_FUNCTIONS(
        nx::vms::client::core::entity_resource_tree::resource_grouping::ResourceGroupingStrings)
...
{
    const auto resourcePool = core::appContext()->currentSystemContext()->resourcePool();
    const auto cloudResourcePool =
        core::appContext()->cloudLayoutsManager()->systemContext()->resourcePool();
