...
#include <nx/vms/client/core/resource_views/entity_item_model/entity/entity_notification_guard.h>
#include <nx/vms/client/core/resource_views/entity_item_model/entity_model_mapping.h>
#include <nx/vms/client/core/resource_views/entity_item_model/item/generic_item/generic_item_builder.h>

namespace {

using ResourceExtraStatus = nx::vms::client::core::ResourceExtraStatus;
using AbstractEntity = nx::vms::client::core::entity_item_model::AbstractEntity;
...
QVariant groupedDeviceExtraStatus(const AbstractEntity* childEntity)
{
    ...
    {
        const auto extraStatusData = childEntity->data(row, nx::vms::client::core::ResourceExtraStatusRole);
...
QVariant GroupEntity::data(int row, int role) const
{
    ...
    if (row == 0
        && role == core::ResourceExtraStatusRole
        && m_headItem->data(core::NodeTypeRole).value<NodeType>() == NodeType::recorder)
    {
