...
class NX_VMS_CLIENT_CORE_API Geometry: public QObject
{
    Q_OBJECT
...
public:
    ...
    */
    ...
    /**
     * Rotates a given point around a {0.5, 0.5} point by a specified standard rotation
     * counter-clockwise.
     */
    Q_INVOKABLE static QPointF rotateRelativePoint(
        const QPointF& point,
    ...
    Q_INVOKABLE static qreal distanceToEdge(const QPointF& p, const QLineF& edge);
