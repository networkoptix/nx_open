...
template class NX_VMS_CLIENT_CORE_API UniqueKeyGroupListEntity<QnResourcePtr>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyGroupListEntity<nx::Uuid>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyGroupListEntity<QString>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyGroupListEntity<QString, utils::CaseInsensitiveStringHasher, utils::CaseInsensitiveStringEqual>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyGroupListEntity<int>;
