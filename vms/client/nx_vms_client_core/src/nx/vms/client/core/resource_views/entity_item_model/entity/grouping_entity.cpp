...
template class NX_VMS_CLIENT_CORE_API GroupingEntity<QString, QnResourcePtr>;
template class NX_VMS_CLIENT_CORE_API GroupingEntity<QString, int>;
template class NX_VMS_CLIENT_CORE_API GroupingEntity<QString, nx::Uuid>;
