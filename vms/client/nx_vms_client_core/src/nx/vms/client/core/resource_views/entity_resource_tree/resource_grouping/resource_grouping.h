 ...
 */
NX_VMS_CLIENT_CORE_API QString getNewGroupSubId();
 ...
 */
NX_VMS_CLIENT_CORE_API QString resourceCustomGroupId(const QnResourcePtr& resource);

/**
 * @param cameraResource Valid pointer to the QnResourcePtr expected.
 * @param compositeId Valid-formed composite ID string that will be stored in the given resource.
 */
NX_VMS_CLIENT_CORE_API void setResourceCustomGroupId(
 ...
 */
NX_VMS_CLIENT_CORE_API bool isValidSubId(const QString& subId);
 ...
 */
NX_VMS_CLIENT_CORE_API QString fixupSubId(const QString& subId);
 ...
 */
NX_VMS_CLIENT_CORE_API QString getResourceTreeDisplayText(const QString& compositeId);
 ...
 */
NX_VMS_CLIENT_CORE_API int compositeIdDimension(const QString& compositeId);
 ...
 */
NX_VMS_CLIENT_CORE_API QString trimCompositeId(const QString& compositeId, int dimension);
 ...
 */
NX_VMS_CLIENT_CORE_API void cutCompositeIdFront(QString& compositeId, int subIdCount);
 ...
 */
NX_VMS_CLIENT_CORE_API QString extractSubId(const QString& compositeId, int subIdOrder);
 ...
 */
NX_VMS_CLIENT_CORE_API QString appendSubId(const QString& compositeId, const QString& subId);
 ...
 *     dimension limit, same composite ID otherwise.
 */
NX_VMS_CLIENT_CORE_API QString insertSubId(const QString& compositeId, const QString& subId,
 ...
 */
NX_VMS_CLIENT_CORE_API QString appendCompositeId(
 ...
 */
NX_VMS_CLIENT_CORE_API QString removeSubId(const QString& compositeId, int subIdOrder);
 ...
 */
NX_VMS_CLIENT_CORE_API QString replaceSubId(const QString& compositeId, const QString& subId,
    int subIdOrder);
