...
#include <nx/vms/client/core/resource_views/entity_item_model/item/shared_item/shared_item_origin.h>

namespace nx::vms::client::core {
namespace entity_item_model {

class NX_VMS_CLIENT_CORE_API SharedItem: public AbstractItem
{
