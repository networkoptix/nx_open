...
template class NX_VMS_CLIENT_CORE_API UniqueKeyListEntity<QnResourcePtr>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyListEntity<nx::Uuid>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyListEntity<QString>;
template class NX_VMS_CLIENT_CORE_API UniqueKeyListEntity<int>;
