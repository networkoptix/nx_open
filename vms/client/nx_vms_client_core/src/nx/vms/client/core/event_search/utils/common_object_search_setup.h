...
class NX_VMS_CLIENT_CORE_API CommonObjectSearchSetup: public QObject
{
    ...
    Q_PROPERTY(UuidList selectedCamerasIds
...
public:
    ...
    UuidList selectedCamerasIds();
    void setSelectedCamerasIds(const UuidList& values);
    ...
    virtual bool selectCameras(UuidSet& selectedCameras) = 0;
