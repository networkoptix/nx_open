 ...
 */
class NX_VMS_CLIENT_CORE_API SingleItemEntity: public AbstractEntity
{
 ...
 */
NX_VMS_CLIENT_CORE_API SingleItemEntityPtr makeSingleItemEntity(AbstractItemPtr item);
