...
#include <nx/vms/client/core/resource_views/entity_item_model/entity/entity_notification_interface.h>
 ...
 */
class NX_VMS_CLIENT_CORE_API BaseNotificatonObserver: public IEntityNotification
{
public:
