...
template class NX_VMS_CLIENT_CORE_API GroupDefiningDataChangeObserver<QnResourcePtr>;
template class NX_VMS_CLIENT_CORE_API GroupDefiningDataChangeObserver<int>;
template class NX_VMS_CLIENT_CORE_API GroupDefiningDataChangeObserver<nx::Uuid>;
