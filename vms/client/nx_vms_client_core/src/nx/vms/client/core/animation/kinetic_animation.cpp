...
qreal KineticAnimation::epsilonSpeed() const
{
    return m_xHelper.epsilonSpeed();
}

void KineticAnimation::setEpsilonSpeed(qreal value)
{
    m_xHelper.setEpsilonSpeed(value);
    m_yHelper.setEpsilonSpeed(value);
}
...
void KineticAnimation::registerQmlType()
{
    qmlRegisterType<KineticAnimation>("nx.vms.client.core", 1, 0, "KineticAnimation");
}
