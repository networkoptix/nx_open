 ...
 * UniqueKeyGroupList.
 */
class NX_VMS_CLIENT_CORE_API GroupEntity: public AbstractEntity
{
 ...
 */
NX_VMS_CLIENT_CORE_API GroupEntityPtr makeGroup(AbstractItemPtr headItem);

/**
 * Convenient non-member factory function.
 */
NX_VMS_CLIENT_CORE_API GroupEntityPtr makeGroup(
