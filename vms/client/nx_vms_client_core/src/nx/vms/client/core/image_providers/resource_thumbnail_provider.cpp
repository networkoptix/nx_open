...
struct ResourceThumbnailProvider::Private
{
        ...
        bool /*resetStatus*/)
    {
        ...
        const bool wasValid = q->status() != ThumbnailStatus::Invalid;
...
ThumbnailStatus ResourceThumbnailProvider::status() const
{
    return d->baseProvider ? d->baseProvider->status() : ThumbnailStatus::Invalid;
}
