...
QHash<int, QByteArray> EntityItemModel::roleNames() const
{
    ...
    roles.insert(core::ResourceFlagsRole, "flags");
    roles.insert(core::ResourceStatusRole, "status");
    roles.insert(core::NodeTypeRole, "nodeType");
    roles.insert(core::ResourceIconKeyRole, "iconKey");
    roles.insert(core::ExtraInfoRole, "extraInfo");
    roles.insert(core::ResourceLogInfoRole, "logInfo");
    roles.insert(core::ForceExtraInfoRole, "forceExtraInfo");
    roles.insert(core::ResourceExtraStatusRole, "resourceExtraStatus");
