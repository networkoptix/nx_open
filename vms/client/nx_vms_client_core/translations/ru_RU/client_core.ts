...
<TS version="2.1" language="ru_RU" sourcelanguage="en">
  ...
  <context>
    ...
    <message>
      ...
      <comment>%1 is the short cloud name (like Cloud)</comment>
      <translation>Вход в систему в выключенном состоянии под именем %1 запрещен. Вы по-прежнему можете подключиться как локальный пользователь.</translation>
    </message>
    <message>
      <source>Log in as a %1 user to the system in a suspended state is forbidden. You can still connect as local user.</source>
      <comment>%1 is the short cloud name (like Cloud)</comment>
      <translation>Вход в систему в приостановленном состоянии под именем %1 запрещен. Вы по-прежнему можете подключиться как локальный пользователь.</translation>
    </message>
    <message>
