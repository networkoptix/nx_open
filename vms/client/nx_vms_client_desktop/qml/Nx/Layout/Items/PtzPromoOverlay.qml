    ...
    function setPagesVisibility(showBasics: bool, showTargetLock: bool)
    {
        ...
        if (showBasics)
        {
            pagesModel.append({
                ...
                "imageUrl": "image://skin/other/200x75/ptz_promo_drag.svg",
            })

            pagesModel.append({
                "title": "",
                "text": qsTr("Press arrow keys to move around. Use plus and minus keys to zoom."),
                "imageUrl": "image://skin/other/200x75/ptz_promo_keys.svg",
            })

            pagesModel.append({
                "title": "",
                "text": qsTr("Use mouse wheel to zoom"),
                "imageUrl": "image://skin/other/200x78/ptz_promo_scroll.svg",
            })
            ...
            pagesModel.append({
                ...
                "imageUrl": "image://skin/other/200x75/ptz_promo_advanced.svg",
            })
            ...
            pagesModel.append({
                ...
                "imageUrl": "image://skin/other/200x75/ptz_promo_old.svg",
            })
        }
        ...
        if (showTargetLock)
        {
            pagesModel.append({
                ...
                "imageUrl": "image://skin/other/200x75/ptz_promo_tracking.svg",
            })
        }
        ...
        pagesModel.append({
            ...
            "imageUrl": "image://skin/other/200x75/ptz_promo_show_again.svg",
        })
