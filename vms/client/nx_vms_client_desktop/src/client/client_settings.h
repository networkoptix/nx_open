...
#include <nx/vms/client/desktop/system_logon/data/connection_data.h>
...
private:
    ...
    QN_BEGIN_PROPERTY_STORAGE(VARIABLE_COUNT)
        ...
        QN_DECLARE_RW_PROPERTY(nx::vms::client::desktop::ConnectionData,
            lastUsedConnection,
        ...
        QN_DECLARE_RW_PROPERTY(
            ...
            SERVER_CERTIFICATE_VALIDATION_LEVEL,
            nx::vms::client::core::ServerCertificateValidationLevel::recommended)
