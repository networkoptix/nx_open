...
void QnClientModule::initSingletons()
{
    ...
    const QString appDataLocation = QStandardPaths::writableLocation(QStandardPaths::DataLocation);
    ...
    m_cloudStatusWatcher = commonModule->store(new QnCloudStatusWatcher(commonModule));
...
void QnClientModule::initNetwork()
{
    ...
    commonModule->store(new nx::vms::client::core::LocalNetworkInterfacesManager());
