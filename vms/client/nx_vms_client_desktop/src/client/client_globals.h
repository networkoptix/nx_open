...
namespace Qn
{
    ...
    */
    enum ItemDataRole
    {
        ...
        FailoverPriorityRole,                       /**< Role for device failover priority (nx::vms::api::FailoverPriority). */
        IsValidResourceRole,                        /**< Role for indication of invalid resource in resource selection dialogs (bool) */
        ...
        MaximumTooltipSizeRole, /**< Role for passing maximum zise of the tooltip (QSize) */
