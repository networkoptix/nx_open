    ...
    const QStringList& fileNames, OverwritePolicy overwritePolicy)
{
    ...
    {
        const QString sourceFilename = sourceDirectory + '/' + filename;
        const QString targetFilename = targetDirectory + '/' + filename;
...
bool deleteFiles(const QString& targetDirectory, const QStringList& fileNames)
{
    ...
    for (const QString& filename : fileNames)
    {
        const QString filePath = targetDirectory + '/' + filename;
