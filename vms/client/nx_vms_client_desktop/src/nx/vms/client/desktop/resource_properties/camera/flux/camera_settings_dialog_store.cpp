...
void CameraSettingsDialogStore::setRecordAudioDisabled(bool value)
{
    d->executeAction(
        [&](State state) { return Reducer::setRecordAudioDisabled(std::move(state), value); });
}
...
void CameraSettingsDialogStore::setRemoteArchiveSynchronizationEnabled(bool value)
{
    d->executeAction(
        [&](State state)
        {
            return Reducer::setRemoteArchiveSynchronizationEnabled(std::move(state), value);
        });
}
...
void CameraSettingsDialogStore::resetDeviceAgentData(
    const nx::Uuid& engineId, const core::DeviceAgentData& data, bool resetUser)
{
    d->executeAction(
        [&](State state)
        {
