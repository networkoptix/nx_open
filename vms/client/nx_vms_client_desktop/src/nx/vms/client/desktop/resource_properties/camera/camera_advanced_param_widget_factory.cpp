...
public:
        ...
        AbstractCameraAdvancedParamWidget(parameter, parent)
    {
        ...
        connect(button, &QPushButton::clicked, this,
            [this, confirmation = parameter.confirmation, actionName = parameter.actionName]()
            {
...
public:
    ...
    {
        // Extremely big width hint to make sure our control will take full width.
