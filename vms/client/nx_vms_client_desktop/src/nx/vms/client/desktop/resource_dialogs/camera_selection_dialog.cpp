...
bool shouldDisplayServersInTree(QnWorkbenchContext* context)
{
    ...
    const bool currentUserAllowedToShowServers =
        isAdmin || context->commonModule()->globalSettings()->showServersInTreeForNonAdmins();
    ...
    ui(new Ui::CameraSelectionDialog())
{
    ...
    m_resourceSelectionWidget =
        new ResourceSelectionWidget(resourceValidator, alertTextProvider, this);
