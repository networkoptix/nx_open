...
nx::common::metadata::DetectionMetadataPacketPtr LocalFileAnalyticsMetadataProvider::metadata(
        ...
        qint64 startTimestamp, qint64 endTimestamp, int channel, int maximumCount) const
{
    ...
    {
        result.append(std::make_shared<nx::common::metadata::DetectionMetadataPacket>(*it));
