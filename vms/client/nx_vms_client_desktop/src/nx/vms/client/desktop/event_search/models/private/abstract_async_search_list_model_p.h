...
public:
    ...
    bool prefetchWindow(const QnTimePeriod& window, PrefetchCompletionHandler completionHandler);
...
private:
    void defaultPrefetchHandler(const QnTimePeriod& fetchedPeriod, FetchResult result);
