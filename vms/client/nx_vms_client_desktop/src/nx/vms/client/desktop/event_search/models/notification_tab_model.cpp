...
struct NotificationTabModel::Private
{
    ...
    ProgressListModel* const progressModel;
};
...
NotificationTabModel::NotificationTabModel(QnWorkbenchContext* context, QObject* parent):
    ...
    d(new Private{
        ...
        new ProgressListModel(context, this)})
{
    ...
    setModels({systemHealthModelProxy, d->progressModel, separatorModel, d->notificationsModel});
}
...
ProgressListModel* NotificationTabModel::progressModel() const
{
