...
public:
    ...
    static bool isHeader(const ViewNodeData& data);
    static bool isHeader(const NodePtr& node);
    ...
    static NodePtr createSeparatorNode(bool isHeader, int groupSortOrder);
