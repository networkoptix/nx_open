 ...
 */
class NX_VMS_CLIENT_DESKTOP_API StateView: public QObject
{
    Q_OBJECT
    Q_PROPERTY(std::vector<nx::vms::client::desktop::analytics::taxonomy::ObjectType*>
...
public:
     ...
     */
    Q_INVOKABLE nx::vms::client::desktop::analytics::taxonomy::ObjectType*
