...
static const QMatrix4x4 kYuvEbu(
    ...
    0.0000f,-0.3960f, 2.0290f, 0.0000f,
    1.1400f,-0.5810f, 0.0000f, 0.0000f,
    0.0000f, 0.0000f, 0.0000f, 1.0000f);

static const QMatrix4x4 kYuvBt601(
    1.0000f, 1.0000f, 1.0000f, 0.0000f,
    0.0000f,-0.3440f, 1.7730f, 0.0000f,
    1.4030f,-0.7140f, 0.0000f, 0.0000f,
    0.0000f, 0.0000f, 0.0000f, 1.0000f);

static const QMatrix4x4 kYuvBt709(
    1.0000f, 1.0000f, 1.0000f, 0.0000f,
    0.0000f,-0.1870f, 1.8556f, 0.0000f,
    1.5701f,-0.4664f, 0.0000f, 0.0000f,
    0.0000f, 0.0000f, 0.0000f, 1.0000f);

static const QMatrix4x4 kYuvSmtp240m(
    1.0000f, 1.0000f, 1.0000f, 0.0000f,
    0.0000f,-0.2253f, 1.8270f, 0.0000f,
    1.5756f,-0.5000f, 0.0000f, 0.0000f,
    0.0000f, 0.0000f, 0.0000f, 1.0000f);
...
QMatrix4x4 colorTransformation(MediaOutputShaderProgram::ColorSpace colorSpace, bool fullRange)
{
    ...
    if (!fullRange)
    {
        result.scale(float(255.0 / (235 - 16)), float(255.0 / (240 - 16)), float(255.0 / (240 - 16)));
        result.translate(float(-16.0 / 255), float(-16.0 / 255), float(-16.0 / 255));
    }
