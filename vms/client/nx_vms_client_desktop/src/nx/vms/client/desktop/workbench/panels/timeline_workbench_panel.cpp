    ...
    m_yAnimator(new VariantAnimator(this))
{
    ...
    action(action::ToggleTimelineAction)->setData(settings.state == Qn::PaneState::Opened);
    ...
    connect(action(action::PinTimelineAction), &QAction::triggered, this,
        [this]
        {
