...
struct LineEditControls::Private
{
    ...
    void addControls(const std::initializer_list<QWidget*>& list, bool prepend)
    {
...
void LineEditControls::addControl(QWidget* control, bool prepend)
{
    d->addControls({control}, prepend);
}

void LineEditControls::addControls(const std::initializer_list<QWidget*>& controls, bool prepend)
{
    d->addControls(controls, prepend);
}
