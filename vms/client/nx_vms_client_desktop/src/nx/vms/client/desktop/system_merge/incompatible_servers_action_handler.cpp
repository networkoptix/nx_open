...
#include <nx/vms/client/desktop/system_logon/logic/remote_connection_user_interaction_delegate.h>
    ...
    const QnFakeMediaServerResourcePtr& server)
{
    ...
    auto delegate =
        std::make_unique<nx::vms::client::desktop::RemoteConnectionUserInteractionDelegate>(
            mainWindowWidget());
