...
class ResourceTreeModelAdapter: public ScopedModelOperations<QIdentityProxyModel>
{
    ...
    Q_PROPERTY(nx::vms::client::core::ResourceTree::FilterType filterType
    ...
    Q_PROPERTY(QVector<nx::vms::client::core::ResourceTree::ShortcutHint> shortcutHints
...
public:
    ...
    Q_INVOKABLE bool isFilterRelevant(nx::vms::client::core::ResourceTree::FilterType type) const;
    ...
    core::ResourceTree::FilterType filterType() const;
    void setFilterType(core::ResourceTree::FilterType value);
    ...
    QVector<core::ResourceTree::ShortcutHint> shortcutHints() const;

    virtual QVariant data(const QModelIndex& index, int role = Qt::DisplayRole) const override;

    virtual QHash<int, QByteArray> roleNames() const override;

    core::ResourceTree::ExpandedNodeId expandedNodeId(const QModelIndex& index) const;
    void setAutoExpandedNodes(const std::optional<QSet<core::ResourceTree::ExpandedNodeId>>& value,
