...
const core::SvgIconColorer::ThemeSubstitutions kTabIconSubstitutions = {
    {QnIcon::Disabled, {.primary = "dark14", .secondary = "dark14", .tertiary = "dark14"}},
    {QnIcon::Selected, {.primary = "light4", .secondary = "light4", .tertiary = "light4"}},
    {QnIcon::Active,
        {.primary = "brand_core", .secondary = "brand_core", .tertiary = "brand_core"}},
    {QnIcon::Normal, {.primary = "light10", .secondary = "light10", .tertiary = "light10"}}};
