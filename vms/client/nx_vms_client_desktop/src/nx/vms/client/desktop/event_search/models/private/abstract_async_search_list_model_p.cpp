...
bool AbstractAsyncSearchListModel::Private::prefetchWindow(
    const QnTimePeriod& window, PrefetchCompletionHandler completionHandler)
{
    ...
    m_request.direction = FetchDirection::earlier;
    m_request.batchSize = q->maximumCount();
    m_request.period = effectiveWindow;
