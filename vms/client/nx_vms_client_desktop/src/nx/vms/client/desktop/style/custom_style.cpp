...
{
    setCustomStyle(palette, colorTheme()->color("red_l2"), disabledOpacity);
}
...
{
    return html::colored(source, colorTheme()->color("red_l2"));
}
...
void setWarningFrame(QWidget* widget, int frameWidth, int roundingRadius)
{
    ...
    const auto color = colorTheme()->color("red_l2");
