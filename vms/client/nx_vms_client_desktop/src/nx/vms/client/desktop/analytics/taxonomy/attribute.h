...
Q_MOC_INCLUDE("nx/vms/client/desktop/analytics/taxonomy/attribute_set.h")
Q_MOC_INCLUDE("nx/vms/client/desktop/analytics/taxonomy/color_set.h")
Q_MOC_INCLUDE("nx/vms/client/desktop/analytics/taxonomy/enumeration.h")
 ...
 */
class NX_VMS_CLIENT_DESKTOP_API Attribute: public QObject
{
    Q_OBJECT
    Q_PROPERTY(QString name MEMBER name CONSTANT)
    Q_PROPERTY(Type type MEMBER type CONSTANT)
    Q_PROPERTY(QString subtype MEMBER subtype CONSTANT)
    Q_PROPERTY(nx::vms::client::desktop::analytics::taxonomy::Enumeration*
        enumeration MEMBER enumeration CONSTANT)
    Q_PROPERTY(nx::vms::client::desktop::analytics::taxonomy::AttributeSet*
        attributeSet MEMBER attributeSet CONSTANT)
    Q_PROPERTY(nx::vms::client::desktop::analytics::taxonomy::ColorSet*
