...
public:
    ...
    static State setRemoteArchiveSyncronizationDisabled(State state);
    static State setRemoteArchiveSyncronizationManual(State state);
    static State setRemoteArchiveSyncronizationAuto(State state);
