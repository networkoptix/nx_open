 ...
 */
class NX_VMS_CLIENT_DESKTOP_API ObjectType: public QObject
{
    Q_OBJECT
    ...
    Q_PROPERTY(std::vector<nx::vms::client::desktop::analytics::taxonomy::Attribute*> attributes
        READ attributes CONSTANT)
    Q_PROPERTY(nx::vms::client::desktop::analytics::taxonomy::ObjectType* baseObjectType
