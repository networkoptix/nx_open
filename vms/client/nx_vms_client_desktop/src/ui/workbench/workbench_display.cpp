...
void QnWorkbenchDisplay::at_workbench_currentLayoutChanged()
{
    ...
    std::sort(sortedItems.begin(), sortedItems.end(),
        [](const QnWorkbenchItem* lhs, const QnWorkbenchItem* rhs)
        {
            ...
            return std::make_pair(lhsResourceDescriptor.id, lhsResourceDescriptor.uniqueId)
                < std::make_pair(rhsResourceDescriptor.id, rhsResourceDescriptor.uniqueId);
        });
    ...
    connect(workbenchLayout, &QnWorkbenchLayout::itemAdded,
        this, &QnWorkbenchDisplay::at_layout_itemAdded);

    connect(workbenchLayout, &QnWorkbenchLayout::itemRemoved,
        this, &QnWorkbenchDisplay::at_layout_itemRemoved);
