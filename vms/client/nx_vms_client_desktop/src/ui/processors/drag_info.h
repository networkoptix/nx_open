...
public:
    ...
    /**
     * Note that this function returns nullptr if current widget is
    ...
    /**
     * Note that this function returns nullptr if current graphics view is
    ...
    /**
     * Note that this function returns nullptr if current graphics scene is
    ...
    /**
     * Note that this function returns nullptr if current graphics item is
