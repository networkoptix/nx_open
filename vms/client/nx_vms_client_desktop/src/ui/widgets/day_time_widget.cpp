...
public:
    QnDayTimeTableWidget(QWidget *parent = nullptr):
        base_type(parent)
    {
    ...
    m_localOffset(0)
{
    ...
    setPaletteColor(this, QPalette::Highlight, colorTheme()->color("dark4"));
    setPaletteColor(this, QPalette::Base, colorTheme()->color("dark7"));
    setPaletteColor(this, QPalette::AlternateBase, colorTheme()->color("dark7"));
