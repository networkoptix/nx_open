...
void QnIoModuleGridOverlayContentsPrivate::InputPortItem::paint(QPainter* painter)
{
    auto idRect = rect().adjusted(
         nx::style::Metrics::kDefaultTopLevelMargin, 0.0,
        -nx::style::Metrics::kDefaultTopLevelMargin, 0.0);
...
void QnIoModuleGridOverlayContentsPrivate::OutputPortItem::paint(QPainter* painter)
{
    ...
    auto idRect = rect().adjusted(nx::style::Metrics::kDefaultTopLevelMargin, 0.0, 0.0, 0.0);
    paintId(painter, idRect, isOn());

    auto margin = effectiveIdWidth() + nx::style::Metrics::kDefaultTopLevelMargin;
    auto labelRect = idRect.adjusted(margin, 0.0, -nx::style::Metrics::kDefaultTopLevelMargin, 0.0);
