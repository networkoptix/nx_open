    ...
    d(new Private{new BusyIndicatorGraphicsWidget(this), new GraphicsLabel(this), new QTimer(this)})
{
    ...
    d->label->setProperty(style::Properties::kDontPolishFontProperty, true);
...
void QnActionIndicatorItem::changeEvent(QEvent* event)
{
    if (event->type() == QEvent::PaletteChange)
        d->indicator->setIndicatorColor(palette().windowText().color());
