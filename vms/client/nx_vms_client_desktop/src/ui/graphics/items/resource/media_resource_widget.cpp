...
void QnMediaResourceWidget::createButtons()
{
    ...
    const auto motionSearchLocalAction = createActionAndButton(
        ...
        {},
        tooltipText(tr("Motion Search"), "M"),
    ...
    const auto objectSearchLocalAction = createActionAndButton(
        ...
        {},
        tooltipText(tr("Object Search"), "O"),
        /*helpTopic*/ {},
...
void QnMediaResourceWidget::processEncryptedArchiveUnlockRequst()
{
    ...
    if (!m_encryptedArchivePasswordDialog)
    {
        m_encryptedArchivePasswordDialog.reset(
            new EncryptedArchivePasswordDialog(context()->mainWindow()));
    }
...
void QnMediaResourceWidget::updateTriggerAvailability(const vms::event::RulePtr& rule)
{
    ...
    const auto isScheduleMatchTime =
        [this](const vms::event::RulePtr& rule)
        {
            ...
            return rule->isScheduleMatchTime(qnSyncTime->currentDateTime());
        };

    const bool buttonEnabled = !button->isLive() || isScheduleMatchTime(rule);
