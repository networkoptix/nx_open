...
public:
    InstrumentEventDispatcherBase(QObject *parent = nullptr): QObject(parent) {}
...
public:
     ...
     */
    InstrumentEventDispatcher(QObject *parent = nullptr);

    /**
     * \param instrument               Instrument to install. Must not be nullptr.
     */
    void installInstrument(Instrument *instrument, InstallationMode::Mode mode, Instrument *reference);

    /**
     * \param instrument               Instrument to uninstall. Must not be nullptr.
     */
    void uninstallInstrument(Instrument *instrument);

    /**
     * \param target                   Target to register. Must not be nullptr.
     */
    void registerTarget(T *target);

    /**
     * \param target                   Target to unregister. Must not be nullptr.
     */
