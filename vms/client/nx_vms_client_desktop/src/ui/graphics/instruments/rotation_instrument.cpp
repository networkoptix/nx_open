...
{
public:
    RotationItem(QGraphicsItem *parent = nullptr):
...
private:
     ...
     */
    QRectF m_boundingRect = Geometry::maxBoundingRect();
};
...
void RotationInstrument::installedNotify() {
    NX_ASSERT(rotationItem() == nullptr);
