    ...
    d_ptr(new QnCameraAccessRightsHelperPrivate(this))
{
    ...
    nx::vms::client::core::UserWatcher *userWatcher = commonModule()->instance<nx::vms::client::core::UserWatcher>();
    connect(userWatcher, &nx::vms::client::core::UserWatcher::userChanged, d, &QnCameraAccessRightsHelperPrivate::at_userWatcher_userChanged);
