...
void QnQuickTextInput::geometryChange(const QRectF& newGeometry, const QRectF& oldGeometry)
{
    Q_D(QnQuickTextInput);
...
void QnQuickTextInput::mouseMoveEvent(QMouseEvent* event)
{
    ...
    d->hscroll = qBound(0.0, d->hscrollWhenPressed - dx, std::max(0.0, hscrollMax));
