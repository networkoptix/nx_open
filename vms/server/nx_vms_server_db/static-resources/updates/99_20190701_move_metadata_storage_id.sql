...
INSERT INTO vms_server_user_attributes (server_guid, server_name, max_cameras, redundancy, backup_type, backup_days_of_the_week, backup_start, backup_duration, backup_bitrate)
     SELECT server_guid, server_name, max_cameras, redundancy, backup_type, backup_days_of_the_week, backup_start, backup_duration, backup_bitrate
