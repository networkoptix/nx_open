...
TEST_F(MetricsServersApi, oneServer)
{
    ...
    EXPECT_GT(startValues["activity"]["transactionsPerSecond"].toDouble(), 0);
...
TEST_F(MetricsServersApi, twoServers)
{
    ...
    const auto mainServerId = commonModule()->moduleGUID().toSimpleString();
    {
        ...
        EXPECT_GT(serverValues["servers"][mainServerId]["activity"]["transactionsPerSecond"].toDouble(), 0);
        ...
        EXPECT_GT(systemValues["servers"][mainServerId]["activity"]["transactionsPerSecond"].toDouble(), 0);
    ...
    const auto secondServerId = secondServer->commonModule()->moduleGUID().toSimpleString();
    {
        ...
        EXPECT_GT(mainServerValues["servers"][mainServerId]["activity"]["transactionsPerSecond"].toDouble(), 0);
        ...
        EXPECT_GT(secondServerValues["servers"][secondServerId]["activity"]["transactionsPerSecond"].toDouble(), 0);
        ...
        EXPECT_GT(systemValues["servers"][secondServerId]["activity"]["transactionsPerSecond"].toDouble(), 0);
    }
    ...
    secondServer.reset();
    {
        ...
        EXPECT_FALSE(systemValues["servers"][secondServerId]["activity"].count("transactionsPerSecond"));
    }
}
