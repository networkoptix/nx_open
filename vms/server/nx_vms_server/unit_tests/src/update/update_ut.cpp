...
TEST_F(FtUpdates, PersistentUpdateStorage_Target_StartUpdate_allPackagesDownloaded)
{
    ...
    whenCorrectUpdateInformationWithEmptyParticipantListSet();
    thenTargetUpdateInformationShouldBeRetrievable();
    thenAllPackagesShouldBeLoaded();
}

TEST_F(FtUpdates, PersistentUpdateStorage_Target_StartUpdate_packagesReplaced)
{
    // #TODO #akulikov Implement!
    givenConnectedPeers(1);
    whenPersistentUpdateStorageDataSet(update::kTargetKey);
    ...
    whenUpdateInformationWithDifferentPackagesIsSet();
    thenAllPackagesShouldBeLoaded();
}

TEST_F(FtUpdates, PersistentUpdateStorage_FinishUpdate_AllFilesInPlace)
{
    // #TODO #akulikov Implement!
    givenConnectedPeers(2);
    whenPersistentUpdateStorageDataSet(update::kTargetKey);
    ...
    thenFinishUpdateShouldSucceed();
    thenAllPackagesShouldBeLoaded();
    thenPersistentUpdateStorageDataShouldbeRotated();
}
