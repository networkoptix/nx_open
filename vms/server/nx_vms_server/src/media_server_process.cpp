...
#include <rest/handlers/server_control_handler.h>
    ...
    ec2::TransactionMessageBusAdapter* messageBus)
{
    ...
    /**%apidoc[proprietary] GET /api/serverControl
     * Intended for debugging and experimenting. Performs various operations on the running Server.
     ...
     * %permissions Owner.
     */
    reg("api/serverControl", new QnServerControlHandler(), kAdmin);
...
void MediaServerProcess::connectSignals()
{
    ...
    connect(
        this, &MediaServerProcess::started,
        [this]() {this->serverModule()->findInstance<Downloader>()->startDownloads(); });
