...
public:
    ...
    ProxyChunk operator[](Base::size_type index)
    {
        return ProxyChunk(this, &Base::operator[](index));
    }

    const Chunk& operator[](Base::size_type index) const
    {
        return Base::operator[](index);
    }

    ProxyChunk at(Base::size_type index)
    {
        return ProxyChunk(this, &Base::operator[](index));
    }

    const Chunk& at(Base::size_type index) const
    {
        return Base::operator[](index);
    }
