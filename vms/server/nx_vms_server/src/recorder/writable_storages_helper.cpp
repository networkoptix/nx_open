...
QnStorageResourceList WritableStoragesHelper::SpaceInfo::toStorageList(
...
QnStorageResourceList WritableStoragesHelper::unique(const QnStorageResourceList& candidates)
{
