    ...
    const QString& libName)
{
    ...
    if (const auto pluginObj = nx::sdk::Ptr<nxpl::Plugin>(obj->queryInterface(nxpl::IID_Plugin)))
    {
    ...
    if (const auto plugin2Obj = nx::sdk::Ptr<nxpl::Plugin2>(obj->queryInterface(nxpl::IID_Plugin2)))
    {
