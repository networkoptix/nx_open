...
private:
    struct Settings
    {
        ...
        std::atomic<bool> generateInstanceOfObjectTypeInheritedFromBaseLibraryType{true};
        std::atomic<bool> generateInstanceOfObjectTypeUsingBaseLibraryEnumType{true};
        std::atomic<bool> generateInstanceOfObjectTypeUsingBaseLibraryColorType{true};
        std::atomic<bool> generateInstanceOfObjectTypeUsingBaseLibraryObjectType{true};
        std::atomic<bool> generateInstanceOfOfBaseLibraryObjectType{true};
