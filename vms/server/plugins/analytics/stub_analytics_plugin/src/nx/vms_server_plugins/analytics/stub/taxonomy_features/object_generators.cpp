...
Ptr<ObjectMetadata> generateInstanceOfObjectTypeInheritedFromBaseLibraryType()
{
    auto objectMetadata = makePtr<ObjectMetadata>();
    objectMetadata->setTypeId("nx.stub.objectTypeInheritedFromBaseLibraryType");
    objectMetadata->addAttributes({
        makePtr<Attribute>(
            "Gender",
            "Man"),
...
Ptr<ObjectMetadata> generateInstanceOfObjectTypeUsingBaseLibraryEnumType()
{
    auto objectMetadata = makePtr<ObjectMetadata>();
    objectMetadata->setTypeId("nx.stub.objectTypeUsingBaseLibraryEnumType");
    objectMetadata->addAttributes({
        makePtr<Attribute>(
...
Ptr<ObjectMetadata> generateInstanceOfObjectTypeUsingBaseLibraryColorType()
{
    auto objectMetadata = makePtr<ObjectMetadata>();
    objectMetadata->setTypeId("nx.stub.objectTypeUsingBaseLibraryColorType");
    objectMetadata->addAttributes({
        makePtr<Attribute>(
...
Ptr<ObjectMetadata> generateInstanceOfObjectTypeUsingBaseLibraryObjectType()
{
    auto objectMetadata = makePtr<ObjectMetadata>();
    objectMetadata->setTypeId("nx.stub.objectTypeUsingBaseLibraryObjectType");
    objectMetadata->addAttributes({
        makePtr<Attribute>(
...
Ptr<ObjectMetadata> generateInstanceOfOfBaseLibraryObjectType()
{
    auto objectMetadata = makePtr<ObjectMetadata>();
