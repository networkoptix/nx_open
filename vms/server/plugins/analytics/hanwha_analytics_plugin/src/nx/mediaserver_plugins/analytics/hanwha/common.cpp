...
QN_DEFINE_METAOBJECT_ENUM_LEXICAL_FUNCTIONS(nx::mediaserver_plugins::analytics::hanwha::Hanwha,
    EventItemType)
...
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(
    nx::mediaserver_plugins::analytics::hanwha::Hanwha::EventType,
    (json), HanwhaEventType_Fields)
QN_FUSION_ADAPT_STRUCT_FUNCTIONS(
    nx::mediaserver_plugins::analytics::hanwha::Hanwha::EngineManifest,
