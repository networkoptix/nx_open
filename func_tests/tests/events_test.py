...
def test_events_reset(one_mediaserver_api):
    rule_dict_list = one_mediaserver_api.generic.get('ec2/getEventRules')
    ...
    one_mediaserver_api.generic.post('ec2/resetEventRules', {})
    rule_dict_list = one_mediaserver_api.generic.get('ec2/getEventRules')
