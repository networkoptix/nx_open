...
from ._cim_query import _CIMReference
...
class WinRM(object):
    ...
    def wmi_class(
            self,
            class_name,
            namespace=CIMClass.default_namespace,
            root_uri=CIMClass.default_root_uri):
        return CIMClass(self._protocol, class_name, namespace=namespace, root_uri=root_uri)
