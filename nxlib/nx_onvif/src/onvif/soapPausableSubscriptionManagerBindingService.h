...
#include "soapH.h"
    ...
    class SOAP_CMAC PausableSubscriptionManagerBindingService {
      public:
        ...
        /// Copy constructor
        PausableSubscriptionManagerBindingService(const PausableSubscriptionManagerBindingService&);
        /// Construct service given a shared managing context
        PausableSubscriptionManagerBindingService(struct soap*);
        ...
        virtual PausableSubscriptionManagerBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        PausableSubscriptionManagerBindingService& operator=(const PausableSubscriptionManagerBindingService&);
        ...
        virtual int Renew(_oasisWsnB2__Renew *oasisWsnB2__Renew, _oasisWsnB2__RenewResponse &oasisWsnB2__RenewResponse) SOAP_PURE_VIRTUAL;
        ...
        virtual int PauseSubscription(_oasisWsnB2__PauseSubscription *oasisWsnB2__PauseSubscription, _oasisWsnB2__PauseSubscriptionResponse &oasisWsnB2__PauseSubscriptionResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'ResumeSubscription' (returns SOAP_OK or error code)
        virtual int ResumeSubscription(_oasisWsnB2__ResumeSubscription *oasisWsnB2__ResumeSubscription, _oasisWsnB2__ResumeSubscriptionResponse &oasisWsnB2__ResumeSubscriptionResponse) SOAP_PURE_VIRTUAL;
    };
#endif
