...
#include "soapH.h"
    ...
    class SOAP_CMAC ReceiverBindingService {
      public:
        ...
        virtual int GetServiceCapabilities(_onvifReceiver__GetServiceCapabilities *onvifReceiver__GetServiceCapabilities, _onvifReceiver__GetServiceCapabilitiesResponse &onvifReceiver__GetServiceCapabilitiesResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetReceivers' (returns SOAP_OK or error code)
        virtual int GetReceivers(_onvifReceiver__GetReceivers *onvifReceiver__GetReceivers, _onvifReceiver__GetReceiversResponse &onvifReceiver__GetReceiversResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetReceiver' (returns SOAP_OK or error code)
        virtual int GetReceiver(_onvifReceiver__GetReceiver *onvifReceiver__GetReceiver, _onvifReceiver__GetReceiverResponse &onvifReceiver__GetReceiverResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'CreateReceiver' (returns SOAP_OK or error code)
        virtual int CreateReceiver(_onvifReceiver__CreateReceiver *onvifReceiver__CreateReceiver, _onvifReceiver__CreateReceiverResponse &onvifReceiver__CreateReceiverResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'DeleteReceiver' (returns SOAP_OK or error code)
        virtual int DeleteReceiver(_onvifReceiver__DeleteReceiver *onvifReceiver__DeleteReceiver, _onvifReceiver__DeleteReceiverResponse &onvifReceiver__DeleteReceiverResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'ConfigureReceiver' (returns SOAP_OK or error code)
        virtual int ConfigureReceiver(_onvifReceiver__ConfigureReceiver *onvifReceiver__ConfigureReceiver, _onvifReceiver__ConfigureReceiverResponse &onvifReceiver__ConfigureReceiverResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'SetReceiverMode' (returns SOAP_OK or error code)
        virtual int SetReceiverMode(_onvifReceiver__SetReceiverMode *onvifReceiver__SetReceiverMode, _onvifReceiver__SetReceiverModeResponse &onvifReceiver__SetReceiverModeResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetReceiverState' (returns SOAP_OK or error code)
        virtual int GetReceiverState(_onvifReceiver__GetReceiverState *onvifReceiver__GetReceiverState, _onvifReceiver__GetReceiverStateResponse &onvifReceiver__GetReceiverStateResponse) SOAP_PURE_VIRTUAL;
    };
#endif
