...
int PullPointBindingService::ssl_run(int port)
{
    if (!soap_valid_socket(this->soap->master) && !soap_valid_socket(this->bind(NULL, port, 100)))
        return this->soap->error;
    for (;;)
...
static int serve___onvifEvents_ppb__GetMessages(struct soap*, PullPointBindingService*);
static int serve___onvifEvents_ppb__DestroyPullPoint(struct soap*, PullPointBindingService*);
static int serve___onvifEvents_ppb__Notify(struct soap*, PullPointBindingService*);
...
int PullPointBindingService::dispatch(struct soap* soap)
{
    ...
    if (!soap_match_tag(soap, soap->tag, "oasisWsnB2:GetMessages"))
        return serve___onvifEvents_ppb__GetMessages(soap, this);
    if (!soap_match_tag(soap, soap->tag, "oasisWsnB2:DestroyPullPoint"))
        return serve___onvifEvents_ppb__DestroyPullPoint(soap, this);
    if (!soap_match_tag(soap, soap->tag, "oasisWsnB2:Notify"))
        return serve___onvifEvents_ppb__Notify(soap, this);
    return soap->error = SOAP_NO_METHOD;
}

static int serve___onvifEvents_ppb__GetMessages(struct soap *soap, PullPointBindingService *service)
{
    ...
    soap_default___onvifEvents_ppb__GetMessages(soap, &soap_tmp___onvifEvents_ppb__GetMessages);
    if (!soap_get___onvifEvents_ppb__GetMessages(soap, &soap_tmp___onvifEvents_ppb__GetMessages, "-onvifEvents-ppb:GetMessages", NULL))
        return soap->error;
    if (soap_body_end_in(soap)
     || soap_envelope_end_in(soap)
     || soap_end_recv(soap))
        return soap->error;
    soap->error = service->GetMessages(soap_tmp___onvifEvents_ppb__GetMessages.oasisWsnB2__GetMessages, oasisWsnB2__GetMessagesResponse);
    if (soap->error)
        return soap->error;
...
static int serve___onvifEvents_ppb__DestroyPullPoint(struct soap *soap, PullPointBindingService *service)
{
    ...
    soap_default___onvifEvents_ppb__DestroyPullPoint(soap, &soap_tmp___onvifEvents_ppb__DestroyPullPoint);
    if (!soap_get___onvifEvents_ppb__DestroyPullPoint(soap, &soap_tmp___onvifEvents_ppb__DestroyPullPoint, "-onvifEvents-ppb:DestroyPullPoint", NULL))
        return soap->error;
    if (soap_body_end_in(soap)
     || soap_envelope_end_in(soap)
     || soap_end_recv(soap))
        return soap->error;
    soap->error = service->DestroyPullPoint(soap_tmp___onvifEvents_ppb__DestroyPullPoint.oasisWsnB2__DestroyPullPoint, oasisWsnB2__DestroyPullPointResponse);
    if (soap->error)
        return soap->error;
    soap->encodingStyle = NULL;
    soap_serializeheader(soap);
...
static int serve___onvifEvents_ppb__Notify(struct soap *soap, PullPointBindingService *service)
{
    struct __onvifEvents_ppb__Notify soap_tmp___onvifEvents_ppb__Notify;
    soap_default___onvifEvents_ppb__Notify(soap, &soap_tmp___onvifEvents_ppb__Notify);
    if (!soap_get___onvifEvents_ppb__Notify(soap, &soap_tmp___onvifEvents_ppb__Notify, "-onvifEvents-ppb:Notify", NULL))
        return soap->error;
    if (soap_body_end_in(soap)
     || soap_envelope_end_in(soap)
     || soap_end_recv(soap))
        return soap->error;
    soap->error = service->Notify(soap_tmp___onvifEvents_ppb__Notify.oasisWsnB2__Notify);
    if (soap->error)
        return soap->error;
    return soap_closesock(soap);
}
