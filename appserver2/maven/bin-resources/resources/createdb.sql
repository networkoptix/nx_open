...
CREATE TABLE "vms_server" ("api_url" varchar(200) NOT NULL, "auth_key" varchar(1024), "streaming_url" varchar(200), "version" varchar(1024), "system_info" varchar(1024), "net_addr_list" varchar(1024), "reserve" bool NOT NULL DEFAULT 0, "resource_ptr_id" integer PRIMARY KEY autoincrement, "panic_mode" smallint NOT NULL);
