...
ALTER TABLE "vms_camera_user_attributes" ADD COLUMN "backup" 		bool 	NOT NULL DEFAULT FALSE;
ALTER TABLE "vms_camera_user_attributes" ADD COLUMN "backup_type" 	integer NOT NULL DEFAULT  0;
