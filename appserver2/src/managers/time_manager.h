...
/**
 * sequence has less priority than TimeSynchronizationManager::peerIsServer and TimeSynchronizationManager::peerTimeSynchronizedWithInternetServer flags.
 */
...
public:
    ...
    qint64 syncTime;
    /**
     * Priority key, corresponding to syncTime value. 
     * This is not necessarily priority key of current server.
...
public:
     ...
     * Cannot do it in constructor to keep valid object destruction order.
