...
namespace ec2
{
    ...
    QN_FUSION_DECLARE_FUNCTIONS_FOR_TYPES((QnTranStateKey)(QnTranState)(QnTranStateResponse), (binary)(json))
    ...
    public:
        ...
        QUuid transactionHash(const ApiResourceData& params) const             { Q_ASSERT_X(0, Q_FUNC_INFO, "Invalid transaction for hash!"); return QUuid(); }
