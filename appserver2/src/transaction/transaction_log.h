...
namespace ec2
{
    ...
    public:
        ...
        ErrorCode saveTransaction(const QnTransaction<ApiLayoutList>& multiTran, const QByteArray& /*serializedTran*/) {
            return saveMultiTransaction<ApiLayoutList, ApiLayout>(multiTran);
        }
