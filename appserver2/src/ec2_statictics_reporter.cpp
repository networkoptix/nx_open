...
static const QString REPORT_ALLOWED = lit("reportAllowed");
static const QString REPORT_LAST_TIME = lit("reportLastTime");
static const QString SYSTEM_ID = lit("systemId");
