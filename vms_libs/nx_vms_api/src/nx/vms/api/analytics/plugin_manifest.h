...
public: //< Required for Qt MOC run.
    ...
    // TODO: Add CameraManager settings and Plugin settings.
};
#define PluginManifest_Fields \
...
Q_DECLARE_OPERATORS_FOR_FLAGS(PluginManifest::Capabilities)
QN_ENABLE_ENUM_NUMERIC_SERIALIZATION(PluginManifest::Capability)
QN_FUSION_DECLARE_FUNCTIONS(PluginManifest::ObjectAction, (json), NX_VMS_API)

} // namespace nx::vms::api::analytics

QN_FUSION_DECLARE_FUNCTIONS(nx::vms::api::analytics::PluginManifest::Capability,
    (metatype)(numeric)(lexical),
    NX_VMS_API)

QN_FUSION_DECLARE_FUNCTIONS(nx::vms::api::analytics::PluginManifest::Capabilities,
    (metatype)(numeric)(lexical),
    NX_VMS_API)
