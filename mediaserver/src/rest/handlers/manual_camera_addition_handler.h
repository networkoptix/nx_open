...
protected:
    ...
    virtual int executePost(const QString& path, const QnRequestParamList& params, const QByteArray& body, QByteArray& resultByteArray, QByteArray& contentType, QByteArray& contentEncoding);
