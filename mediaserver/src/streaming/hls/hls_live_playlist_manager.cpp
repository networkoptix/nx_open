...
static const double DEFAULT_HLS_TARGET_DURATION_MICROS = 5*1000*1000;

HLSLivePlaylistManager::ChunkData::ChunkData()
:
    startTimestamp( 0 ),
    duration( 0 ),
    mediaSequence( 0 )
...
:
    ...
    m_targetDurationUSec( DEFAULT_HLS_TARGET_DURATION_MICROS ),
    m_prevTimestamp( 0 ),
    m_mediaSequence( 0 ),
...
*/
unsigned int HLSLivePlaylistManager::generateChunkListForLivePlayback( std::vector<HLSLivePlaylistManager::ChunkData>* const chunkList ) const
{
