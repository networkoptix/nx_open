...
#include <rest/handlers/upload_update_rest_handler.h>
...
void QnMain::initTcpListener()
{
    ...
    QnRestProcessorPool::instance()->registerHandler("api/uploadUpdate", new QnUploadUpdateRestHandler());
    QnRestProcessorPool::instance()->registerHandler("api/update", new QnUpdateRestHandler());
#ifdef ENABLE_ACTI
