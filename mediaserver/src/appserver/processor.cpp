...
void QnAppserverResourceProcessor::processResources(const QnResourceList &resources)
{
    ...
    foreach (QnResourcePtr resource, resources)
    {
        ...
        if( errorCode != ec2::ErrorCode::ok ) {
            qCritical() << "QnAppserverResourceProcessor::processResources(): Call to addCamera failed. Reason: "; // todo: addReason
            continue;
        }
...
void QnAppserverResourceProcessor::requestFinished2(ec2::ReqID /*reqID*/, ec2::ErrorCode errCode, const QnId& id)
{
