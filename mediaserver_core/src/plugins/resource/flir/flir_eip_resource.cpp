...
namespace {
    constexpr const std::chrono::milliseconds kIOCheckTimeout = std::chrono::milliseconds(3000);
    constexpr const std::chrono::milliseconds kAlarmCheckTimeout = std::chrono::milliseconds(300);
