...
std::unique_ptr<nx_http::HttpClient> IqInvisionRequestHelper::makeHttpClient() const
{
...
QUrl IqInvisionRequestHelper::buildOidUrl(const QString & oid) const
{
...
QUrl IqInvisionRequestHelper::buildSetOidUrl(const QString & oid, const QString & value) const
{
    QUrl url(m_resource->getUrl());
...
IqInvisionResponse IqInvisionRequestHelper::doRequest(const QUrl& url)
{
