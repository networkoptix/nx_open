...
private:
    nx::network::server::SerializerState::Type serializeHeader(nx::Buffer* const buffer);
    nx::network::server::SerializerState::Type serializeData(nx::Buffer* const buffer);
