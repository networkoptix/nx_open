    ...
    const QnRestConnectionProcessor* processor)
{
    ...
    if (!updateId.isEmpty() && body.isEmpty())
    {
        /* TODO: #3.1 Check user rights for this case too
           when offline cloud authentication is implemented.
           Also see "/api/installUpdates" registration in media_server_process.cpp
        */
    ...
    if (!updateId.isEmpty() && params.contains(lit("offset")))
