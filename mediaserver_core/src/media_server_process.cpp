    ...
    ec2::QnTransactionMessageBus* messageBus)
{
    ...
    reg("api/events", new QnEventLogRestHandler(), Qn::GlobalViewLogsPermission); //< deprecated
    reg("api/getEvents", new QnEventLog2RestHandler(), Qn::GlobalViewLogsPermission); //< new version
