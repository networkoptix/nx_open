...
void dropConnectionsToRemotePeers(ec2::TransactionMessageBusSelector* messageBus)
{
...
bool changeLocalSystemId(const ConfigureSystemData& data, ec2::TransactionMessageBusSelector* messageBus)
{
