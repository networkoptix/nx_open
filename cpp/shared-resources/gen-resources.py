...
if __name__ == '__main__':
  ...
  genqrc('build/${project.artifactId}-skin.qrc', '/skin', '${basedir}/resource/custom/${custom.skin}/skin', ['.png', '.mkv'])
  genqrc('build/${project.artifactId}-icons.qrc', '/', '${basedir}/../cpp/shared-resources/icons/${custom.skin}', [''])
