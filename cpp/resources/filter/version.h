...
#define QN_APPLICATION_NAME             "${PROJECT_LONGNAME}"
#define QN_APPLICATION_DISPLAY_NAME     "${PROJECT_DISPLAY_LONGNAME}"
#define QN_APPLICATION_VERSION          "${release.version}"
#ifdef _WIN32
...
#define QN_ENGINE_VERSION               "${release.version}"
...
#define QN_HELP_URL                     "${helpUrl}/${customization}/${majorVersion}/${minorVersion}/url"
...
#define VER_FILEVERSION                 ${majorVersion},${minorVersion},${incrementalVersion},${buildNumber}
#define VER_FILEVERSION_STR             "${release.version}.${buildNumber}"
#define VER_PRODUCTVERSION              ${majorVersion},${minorVersion},${incrementalVersion}
#define VER_PRODUCTVERSION_STR          "${full.version}"
#define VER_COMPANYNAME_STR             "${company.name}"
#define VER_FILEDESCRIPTION_STR         "${PROJECT_LONGNAME}"
#define VER_INTERNALNAME_STR            "${PROJECT_DISPLAY_LONGNAME}"
