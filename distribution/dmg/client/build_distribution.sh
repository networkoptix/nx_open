...
# "$PROTOCOL_HANDLER_APP_NAME" = "$DISPLAY_PRODUCT_NAME Client.app".
# Do not add the "Client" word to APP_DIR because of that.
...
buildDistribution()
{
    ...
    mv "$APP_DIR/Contents/MacOS/protocol_handler.app" \
        "$APP_DIR/Contents/MacOS/$PROTOCOL_HANDLER_APP_NAME"
