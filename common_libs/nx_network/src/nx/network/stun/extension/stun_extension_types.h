...
struct NX_NETWORK_API TrafficRelayEndpoint: Endpoint
{
    static const AttributeType TYPE = trafficRelayEndpoint;
    TrafficRelayEndpoint( const SocketAddress& endpoint )
