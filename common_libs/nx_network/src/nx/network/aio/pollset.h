...
public:
    ...
    */
    ...
    /*!
        NOTE: Ivalidates all iterators to the left of removed element. So, it is ok to iterate signalled sockets and remove current element:
    ...
    */
    ...
    //!Returns iterator pointing to first socket, which state has been changed in previous poll call
    const_iterator begin() const;
    //!Returns iterator pointing to next element after last socket, which state has been changed in previous poll call
