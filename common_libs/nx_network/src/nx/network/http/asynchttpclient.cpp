    ...
    AsyncHttpClient::Timeouts timeouts)
{
    ...
    downloadFileAsyncEx2(url, completionHandler, std::move(httpClient));
}

void downloadFileAsync2(
    const QUrl& url,
    ...
    AsyncHttpClient::Timeouts timeouts)
{
    ...
    downloadFileAsyncEx2(url, handler, extraHeaders, authType, timeouts);
}
