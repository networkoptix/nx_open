...
#include "soapH.h"
    ...
    class SOAP_CMAC ReplayBindingService {
      public:
        ...
        ReplayBindingService(struct soap*);
        ...
        virtual int GetServiceCapabilities(_onvifReplay__GetServiceCapabilities *onvifReplay__GetServiceCapabilities, _onvifReplay__GetServiceCapabilitiesResponse &onvifReplay__GetServiceCapabilitiesResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetReplayUri' (returns SOAP_OK or error code)
        virtual int GetReplayUri(_onvifReplay__GetReplayUri *onvifReplay__GetReplayUri, _onvifReplay__GetReplayUriResponse &onvifReplay__GetReplayUriResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetReplayConfiguration' (returns SOAP_OK or error code)
        virtual int GetReplayConfiguration(_onvifReplay__GetReplayConfiguration *onvifReplay__GetReplayConfiguration, _onvifReplay__GetReplayConfigurationResponse &onvifReplay__GetReplayConfigurationResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'SetReplayConfiguration' (returns SOAP_OK or error code)
        virtual int SetReplayConfiguration(_onvifReplay__SetReplayConfiguration *onvifReplay__SetReplayConfiguration, _onvifReplay__SetReplayConfigurationResponse &onvifReplay__SetReplayConfigurationResponse) SOAP_PURE_VIRTUAL;
    };
#endif
