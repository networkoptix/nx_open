...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const NotificationProducerBindingProxy& rhs)
{	this->soap = rhs.soap;
	this->soap_own = false;
...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const char *endpoint)
{	this->soap = soap_new();
	this->soap_own = true;
	NotificationProducerBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const char *endpoint, soap_mode iomode)
{	this->soap = soap_new();
	this->soap_own = true;
	NotificationProducerBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
...
NotificationProducerBindingProxy *NotificationProducerBindingProxy::copy()
{	NotificationProducerBindingProxy *dup = SOAP_NEW_UNMANAGED(NotificationProducerBindingProxy);
	if (dup)
	{	soap_done(dup->soap);
...
NotificationProducerBindingProxy& NotificationProducerBindingProxy::operator=(const NotificationProducerBindingProxy& rhs)
...
void NotificationProducerBindingProxy::soap_header(char *wsa5__MessageID, struct wsa5__RelatesToType *wsa5__RelatesTo, struct wsa5__EndpointReferenceType *wsa5__From, struct wsa5__EndpointReferenceType *wsa5__ReplyTo, struct wsa5__EndpointReferenceType *wsa5__FaultTo, char *wsa5__To, char *wsa5__Action, struct chan__ChannelInstanceType *chan__ChannelInstance, struct wsdd__AppSequenceType *wsdd__AppSequence, struct _wsse__Security *wsse__Security, char *subscriptionID)
...
::SOAP_ENV__Header *NotificationProducerBindingProxy::soap_header()
{	return this->soap->header;
}

::SOAP_ENV__Fault *NotificationProducerBindingProxy::soap_fault()
...
int NotificationProducerBindingProxy::Subscribe(const char *endpoint, const char *soap_action, _oasisWsnB2__Subscribe *oasisWsnB2__Subscribe, _oasisWsnB2__SubscribeResponse &oasisWsnB2__SubscribeResponse)
{
	...
	soap_tmp___onvifEvents_npb__Subscribe.oasisWsnB2__Subscribe = oasisWsnB2__Subscribe;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___onvifEvents_npb__Subscribe(soap, &soap_tmp___onvifEvents_npb__Subscribe);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___onvifEvents_npb__Subscribe(soap, &soap_tmp___onvifEvents_npb__Subscribe, "-onvifEvents-npb:Subscribe", "")
	...
	if (!static_cast<_oasisWsnB2__SubscribeResponse*>(&oasisWsnB2__SubscribeResponse)) // NULL ref?
		return soap_closesock(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	oasisWsnB2__SubscribeResponse.soap_get(soap, "oasisWsnB2:SubscribeResponse", NULL);
	if (soap->error)
...
int NotificationProducerBindingProxy::GetCurrentMessage(const char *endpoint, const char *soap_action, _oasisWsnB2__GetCurrentMessage *oasisWsnB2__GetCurrentMessage, _oasisWsnB2__GetCurrentMessageResponse &oasisWsnB2__GetCurrentMessageResponse)
{
	...
	soap_tmp___onvifEvents_npb__GetCurrentMessage.oasisWsnB2__GetCurrentMessage = oasisWsnB2__GetCurrentMessage;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___onvifEvents_npb__GetCurrentMessage(soap, &soap_tmp___onvifEvents_npb__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___onvifEvents_npb__GetCurrentMessage(soap, &soap_tmp___onvifEvents_npb__GetCurrentMessage, "-onvifEvents-npb:GetCurrentMessage", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!static_cast<_oasisWsnB2__GetCurrentMessageResponse*>(&oasisWsnB2__GetCurrentMessageResponse)) // NULL ref?
		return soap_closesock(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	oasisWsnB2__GetCurrentMessageResponse.soap_get(soap, "oasisWsnB2:GetCurrentMessageResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
