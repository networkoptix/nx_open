...
int AdvancedSecurityServiceBindingProxy::GetServiceCapabilities(const char *endpoint, const char *soap_action, _onvifAdvancedSecurity__GetServiceCapabilities *onvifAdvancedSecurity__GetServiceCapabilities, _onvifAdvancedSecurity__GetServiceCapabilitiesResponse &onvifAdvancedSecurity__GetServiceCapabilitiesResponse)
{
	...
	soap_tmp___onvifAdvancedSecurity_assb__GetServiceCapabilities.onvifAdvancedSecurity__GetServiceCapabilities = onvifAdvancedSecurity__GetServiceCapabilities;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize___onvifAdvancedSecurity_assb__GetServiceCapabilities(soap, &soap_tmp___onvifAdvancedSecurity_assb__GetServiceCapabilities);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___onvifAdvancedSecurity_assb__GetServiceCapabilities(soap, &soap_tmp___onvifAdvancedSecurity_assb__GetServiceCapabilities, "-onvifAdvancedSecurity-assb:GetServiceCapabilities", "")
	...
	if (!static_cast<_onvifAdvancedSecurity__GetServiceCapabilitiesResponse*>(&onvifAdvancedSecurity__GetServiceCapabilitiesResponse)) // NULL ref?
		return soap_closesock(soap);
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	onvifAdvancedSecurity__GetServiceCapabilitiesResponse.soap_get(soap, "onvifAdvancedSecurity:GetServiceCapabilitiesResponse", NULL);
	if (soap->error)
