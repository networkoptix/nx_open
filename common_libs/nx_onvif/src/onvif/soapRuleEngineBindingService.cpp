...
static int serve___onvifAnalytics_reb__CreateRules(struct soap*, RuleEngineBindingService*);
static int serve___onvifAnalytics_reb__DeleteRules(struct soap*, RuleEngineBindingService*);
static int serve___onvifAnalytics_reb__GetRules(struct soap*, RuleEngineBindingService*);
static int serve___onvifAnalytics_reb__GetRuleOptions(struct soap*, RuleEngineBindingService*);
