...
{ public:
	...
	virtual	int send_Hello_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
	...
	virtual	int send_Bye_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
	...
	virtual	int send_Probe_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
	...
	virtual	int send_ProbeMatches_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
	...
	virtual	int send_Resolve_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
	...
	virtual	int send_ResolveMatches_empty_response(int httpcode) { return soap_send_empty_response(this->soap, httpcode); }
};
#endif
