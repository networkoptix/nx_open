...
SubscriptionManagerBindingProxy::SubscriptionManagerBindingProxy(const char *endpoint)
{
    this->soap = soap_new();
    this->soap_own = true;
    SubscriptionManagerBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
SubscriptionManagerBindingProxy::SubscriptionManagerBindingProxy(const char *endpoint, soap_mode iomode)
{
    this->soap = soap_new();
    this->soap_own = true;
    SubscriptionManagerBindingProxy_init(iomode, iomode);
...
int SubscriptionManagerBindingProxy::Renew(const char *endpoint, const char *soap_action, _oasisWsnB2__Renew *oasisWsnB2__Renew, _oasisWsnB2__RenewResponse &oasisWsnB2__RenewResponse)
{
    ...
    soap_tmp___onvifEvents_smb__Renew.oasisWsnB2__Renew = oasisWsnB2__Renew;
    soap_begin(soap);
    ...
    if (!static_cast<_oasisWsnB2__RenewResponse*>(&oasisWsnB2__RenewResponse)) // NULL ref?
        return soap_closesock(soap);
    ...
    if (soap_begin_recv(soap)
     ...
     || soap_body_begin_in(soap))
        return soap_closesock(soap);
    oasisWsnB2__RenewResponse.soap_get(soap, "oasisWsnB2:RenewResponse", NULL);
    if (soap->error)
...
int SubscriptionManagerBindingProxy::Unsubscribe(const char *endpoint, const char *soap_action, _oasisWsnB2__Unsubscribe *oasisWsnB2__Unsubscribe, _oasisWsnB2__UnsubscribeResponse &oasisWsnB2__UnsubscribeResponse)
{
    ...
    soap_tmp___onvifEvents_smb__Unsubscribe.oasisWsnB2__Unsubscribe = oasisWsnB2__Unsubscribe;
    soap_begin(soap);
    soap->encodingStyle = NULL;
    soap_serializeheader(soap);
