...
int CreatePullPointBindingService::ssl_run(int port)
{	if (!soap_valid_socket(this->soap->master) && !soap_valid_socket(this->bind(NULL, port, 100)))
		return this->soap->error;
	for (;;)
	{	if (!soap_valid_socket(this->accept()))
...
static int serve___onvifEvents_cpb__CreatePullPoint(struct soap*, CreatePullPointBindingService*);
...
int CreatePullPointBindingService::dispatch(struct soap* soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "oasisWsnB2:CreatePullPoint"))
		return serve___onvifEvents_cpb__CreatePullPoint(soap, this);
	return soap->error = SOAP_NO_METHOD;
}

static int serve___onvifEvents_cpb__CreatePullPoint(struct soap *soap, CreatePullPointBindingService *service)
{	struct __onvifEvents_cpb__CreatePullPoint soap_tmp___onvifEvents_cpb__CreatePullPoint;
	...
	soap_default___onvifEvents_cpb__CreatePullPoint(soap, &soap_tmp___onvifEvents_cpb__CreatePullPoint);
	if (!soap_get___onvifEvents_cpb__CreatePullPoint(soap, &soap_tmp___onvifEvents_cpb__CreatePullPoint, "-onvifEvents-cpb:CreatePullPoint", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = service->CreatePullPoint(soap_tmp___onvifEvents_cpb__CreatePullPoint.oasisWsnB2__CreatePullPoint, oasisWsnB2__CreatePullPointResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	oasisWsnB2__CreatePullPointResponse.soap_serialize(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || oasisWsnB2__CreatePullPointResponse.soap_put(soap, "oasisWsnB2:CreatePullPointResponse", "")
