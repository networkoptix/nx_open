...
#include "soapH.h"
    ...
    class SOAP_CMAC RemoteDiscoveryBindingService {
      public:
        ...
        virtual int Hello(const struct wsdd__HelloType& onvifNetwork__Hello, struct wsdd__ResolveType &onvifNetwork__HelloResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Bye' (returns SOAP_OK or error code)
        virtual int Bye(const struct wsdd__ByeType& onvifNetwork__Bye, struct wsdd__ResolveType &onvifNetwork__ByeResponse) SOAP_PURE_VIRTUAL;
    };
#endif
