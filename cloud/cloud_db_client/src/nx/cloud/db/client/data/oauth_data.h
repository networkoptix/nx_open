...
constexpr auto nxReflectVisitAllEnumItems(IssueTokenRequest::GrantType*, Visitor&& visitor)
{
    using GrantType = IssueTokenRequest::GrantType;
...
NX_REFLECTION_INSTRUMENT_ENUM(IssueTokenRequest::ResponseType,
    token,
    code
)
...
#define Issue_code_response_Fields (access_code)(error)
