...
#define AccountData_Fields \
    ...
    (httpDigestAuthEnabled)(account2faEnabled)
...
#define AccountUpdateData_Fields (passwordHa1)(password)(fullName)(customization)
...
#define AccountForSharing_Fields (id)(email)(fullName)(statusCode)(account2faEnabled)(intermediateResponse)
