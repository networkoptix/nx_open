...
static constexpr char kAuthResolveUserCredentials[] = "/cdb/auth_provider/resource";
static constexpr char kAuthSystemAccessLevel[] = "/cdb/auth_provider/system/{systemId}/access_level";
