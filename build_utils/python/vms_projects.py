...
translatableProjects = [
    ...
    TranslatableProject("client_base", "client"),
    TranslatableProject("client_ui", "client").ui(),
    TranslatableProject("mobile_client_base", "mobile_client"),
    TranslatableProject("mobile_client_qml", "mobile_client").qml()
]
