...
HEADERS += ui/videoitem/subitem/abstract_sub_item.h  ui/videoitem/subitem/close_sub_item.h
SOURCES += ui/videoitem/subitem/abstract_sub_item.cpp  ui/videoitem/subitem/close_sub_item.cpp
