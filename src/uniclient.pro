...
HEADERS += videodisplay/animation/scene_movement.h videodisplay/animation/scene_zoom.h
...
SOURCES += videodisplay/animation/scene_movement.cpp videodisplay/animation/scene_zoom.cpp
