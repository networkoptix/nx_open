...
HEADERS += ui/animation/animation.h
HEADERS += ui/animation/animation_manager.h
HEADERS += ui/animation/animation_timeline.h
HEADERS += ui/animation/group_animation.h
...
HEADERS += ui/video_cam_layout/grid_engine.h
...
HEADERS += ui/videoitem/grid_item.h
...
SOURCES += ui/animation/animation.cpp
SOURCES += ui/animation/animation_manager.cpp
SOURCES += ui/animation/animation_timeline.cpp
SOURCES += ui/animation/group_animation.cpp
...
SOURCES += ui/video_cam_layout/grid_engine.cpp
...
SOURCES += ui/videoitem/grid_item.cpp
