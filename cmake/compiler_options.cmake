    ...
    foreach(sanitizer ${enabledSanitizers})
        ...
        if(sanitizer STREQUAL "address")
            ...
            if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
                string(APPEND ASAN_OPTIONS " -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/asan-blacklist.txt")
            endif()
            add_compile_options(-fno-omit-frame-pointer)
            string(APPEND CMAKE_SHARED_LINKER_FLAGS "${ASAN_OPTIONS}")
            string(APPEND CMAKE_EXE_LINKER_FLAGS "${ASAN_OPTIONS}")
        endif()
    endforeach()
endif()
