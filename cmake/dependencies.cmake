...
macro(load_generated_dependencies_file)
    ...
    set(QT_DIR ${RDEP_QT_ROOT})
    set(icu_directory ${RDEP_ICU_ROOT})
    set(ucrt_directory ${RDEP_WINSDK-REDIST_ROOT})
    set(vcrt_directory ${RDEP_MSVC_ROOT})
    set(RDEP_WIX_ROOT ${RDEP_WIX_ROOT})
    set(help_directory ${RDEP_HELP_ROOT})
    set(roboto_fonts_directory ${RDEP_ROBOTO-FONTS_ROOT})
    set(festival_vox_directory ${RDEP_FESTIVAL-VOX_ROOT})
endmacro()
