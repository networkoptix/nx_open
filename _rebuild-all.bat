...
call mvn clean package -T 4 --projects appserver,genericrtspplugin,axiscamplugin -P!installer %CUSTOMIZATION% %ARCH% 
call mvn clean compile -T 4 -rf common -P!installer %CUSTOMIZATION% %ARCH% 
