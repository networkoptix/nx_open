...
public:
    QnTCPConnectionProcessor(AbstractStreamSocket* socket, QnTcpListener* owner);
...
protected:
    ...
    QnTCPConnectionProcessor(QnTCPConnectionProcessorPrivate* d_ptr, AbstractStreamSocket* socket, QnTcpListener* owner);
private:
