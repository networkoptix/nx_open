...
public:
    ...
    */
    ...
    void executeUpdate(
        nx::utils::MoveOnlyFunc<DBResult(db::QueryContext*, const InputData&, OutputData* const)> dbUpdateFunc,
        InputData input,
        nx::utils::MoveOnlyFunc<void(db::QueryContext*, DBResult, InputData, OutputData)> completionHandler)
    {
    ...
    void executeUpdate(
        nx::utils::MoveOnlyFunc<DBResult(db::QueryContext*, const InputData&)> dbUpdateFunc,
        InputData input,
        nx::utils::MoveOnlyFunc<void(db::QueryContext*, DBResult, InputData)> completionHandler)
    {
        openOneMoreConnectionIfNeeded();
    ...
    void executeUpdate(
        nx::utils::MoveOnlyFunc<DBResult(db::QueryContext*)> dbUpdateFunc,
        nx::utils::MoveOnlyFunc<void(db::QueryContext*, DBResult)> completionHandler)
    {
        openOneMoreConnectionIfNeeded();
    ...
    void executeSelect(
        nx::utils::MoveOnlyFunc<DBResult(db::QueryContext*, OutputData* const)> dbSelectFunc,
        nx::utils::MoveOnlyFunc<void(db::QueryContext*, DBResult, OutputData)> completionHandler)
    {
        openOneMoreConnectionIfNeeded();
