...
void TimerManager::run()
{
    ...
    cl_log.log( QString::fromLatin1("TimerManager started"), cl_logDEBUG1 );
    ...
    while( !m_impl->terminated )
    {
        try
        {
            ...
            for( ;; )
            {
                ...
                {
                    cl_log.log( QString::fromLatin1("TimerManager. Error. Exception in %1:%2. %3").arg(QLatin1String(__FILE__)).arg(__LINE__).arg(QLatin1String(e.what())), cl_logERROR );
                }
                catch( ... )
                {
                    cl_log.log( QString::fromLatin1("TimerManager. Unknown exception in %1:%2").arg(QLatin1String(__FILE__)).arg(__LINE__), cl_logERROR );
                }
    ...
    cl_log.log( QString::fromLatin1("TimerManager stopped"), cl_logDEBUG1 );
}
