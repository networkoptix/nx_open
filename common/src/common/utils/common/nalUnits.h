...
private:
	...
	void sei_payload(SPSUnit& sps, int payloadType, quint8* curBuf, int payloadSize, int orig_hrd_parameters_present_flag);
	void buffering_period(int payloadSize) ;
	void pic_timing(SPSUnit& sps, quint8* curBuf, int payloadSize, bool orig_hrd_parameters_present_flag);
