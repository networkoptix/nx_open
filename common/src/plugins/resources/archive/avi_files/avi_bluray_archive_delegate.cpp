...
QnAVIBlurayArchiveDelegate::QnAVIBlurayArchiveDelegate():
...
QStringList QnAVIBlurayArchiveDelegate::getPlaylist(const QString& url)
{
    QStringList rez;
    QDir sourceDir = url;
...
void QnAVIBlurayArchiveDelegate::fillAdditionalInfo(CLFileInfo* fi)
{
