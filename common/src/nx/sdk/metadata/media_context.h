...
/**
 * Each class that implements MediaContext interface
...
/**
 * @brief The MediaContext class is an interface for decoding / encoding context.
 */
class MediaContext: public nxpl::PluginInterface
{
public:
    /**
