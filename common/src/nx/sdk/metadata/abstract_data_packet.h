...
/**
 * Each class that implements AbstractDataPacket interface
...
/**
 * @brief The AbstractDataPacket class is a base class for every class that represents
 * the packet of the data (e.g. audio, video, metadata).
 */
