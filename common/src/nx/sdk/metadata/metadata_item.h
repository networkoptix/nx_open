...
/**
 * Each class that implements MetadataItem interface
...
/**
 * @brief The MetadataItem class is an interface for particular
 * item of metadata (e.g. event, detected object) which is contained in a metadata packet.
 */
class MetadataItem: public nxpl::PluginInterface
{
public:
    /**
