...
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(QnBusiness::EventReason)
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(QnBusiness::EventState)
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(QnBusiness::EventType)
QN_DEFINE_LEXICAL_JSON_FUNCTIONS(QnBusiness::ActionType)
