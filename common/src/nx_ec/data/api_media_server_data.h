...
struct ApiStorageData: nx::vms::api::ResourceData
{
    ...
    bool isBackup; /**< Whether the storage is used for backup. */
};
...
#define ApiMediaServerData_Fields ResourceData_Fields \
    (networkAddresses)(flags)(version)(systemInfo)(authKey)
...
#define ApiMediaServerDataEx_Fields ApiMediaServerData_Fields \
    ApiMediaServerUserAttributesData_Fields_Short (status)(addParams) (storages)
