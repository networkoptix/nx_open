    ...
    */
    namespace qt
    {
        ...
        public:
            ...
            void emitGetCamerasHistoryDone( const ErrorCode p1, const ApiCameraHistoryDataList& p2 ) { emit onGetCamerasHistoryDone( p1, p2 ); }
        ...
        signals:
            ...
            void onGetCamerasHistoryDone( const ErrorCode, const ApiCameraHistoryDataList& );
