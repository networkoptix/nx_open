...
protected:
    ...
    void resetCamerasWithArchiveList(const ec2::ApiCameraHistoryDataList &cameraHistoryList);
...
private slots:
    ...
    void on_cameraHistoryChanged(const ec2::ApiCameraHistoryData &cameraHistory);
