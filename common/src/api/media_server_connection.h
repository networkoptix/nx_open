...
namespace detail {
    ...
    public slots:
        void at_replyReceived(int status, const QnReplyHeaderList& replyHeaders, const QByteArray &reply, const QByteArray &errorString, int handle);
    ...
    public slots:
        void at_searchReplyReceived(int status, const QnReplyHeaderList& replyHeaders, const QByteArray &reply, const QByteArray &errorString , int handle);
        void at_addReplyReceived(int status, const QnReplyHeaderList& replyHeaders, const QByteArray &reply, const QByteArray &errorString , int handle);
