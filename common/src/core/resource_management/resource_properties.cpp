...
bool QnResourcePropertyDictionary::saveParams(const QnUuid& resourceId)
{
    ...
    //TODO: #GDM SafeMode
    ec2::ErrorCode rez = conn->getResourceManager(Qn::kSuperUserAccess)->saveSync(params, &outData);
...
int QnResourcePropertyDictionary::saveData(const ec2::ApiResourceParamWithRefDataList&& data)
{
    ...
    //TODO: #GDM SafeMode
    int requestId = conn->getResourceManager(Qn::kSuperUserAccess)->save(data, this, &QnResourcePropertyDictionary::onRequestDone);
