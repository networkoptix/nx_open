...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    /** 
     * @return new serial single-threaded executor.
     */
    public static final Executor createExecutor() {
        return Utils.hasHoneycomb() ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);
    }
    
    /** 
     * @return new serial multi-threaded executor.
     */
    public static final Executor createExecutor(int threadCount) {
        return Executors.newFixedThreadPool(threadCount, sThreadFactory);
    }
