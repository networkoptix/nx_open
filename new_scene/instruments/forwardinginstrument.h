...
class ForwardingInstrument: public Instrument {
    Q_OBJECT;
public:
    ForwardingInstrument(const QSet<QEvent::Type> &sceneEventTypes, const QSet<QEvent::Type> &viewEventTypes, const QSet<QEvent::Type> &viewportEventTypes, bool watchesItemEvents, QObject *parent):
