...
set(display_mobile_bundle_name "DW Spectrum")
...
set(installer.name "dwspectrum")
set(android.packageName "com.digitalwatchdog.dwmobile")
set(android.oldPackageName "com.digitalwatchdog.dwspectrum")
set(android.alias "dwspectrum")
set(android.storepass "sBc78YlT")
set(android.keypass "bWH2mSxh")
...
set(customization.nxtoolBundleUpgradeCode "{6516fcdc-682b-4548-8fc3-a632473a76d2}")
set(customization.axBundleUpgradeCode "{03CCE76A-132B-4654-A1AD-6C7E5A795EE1}")

set(deb.customization.company.name "digitalwatchdog")

set(ax.className "DWSpectrum")
set(ax.classId "{4B70A9BD-DE07-4D84-B57C-BDB71100F95B}")
set(ax.interfaceId "{9783176A-3E2B-4F4B-8570-586605655113}")
set(ax.eventsId "{18E4C8CE-155C-456A-B398-AE84ADF442AA}")
set(ax.typeLibId "{5ADE482A-E57D-4FBD-84D6-CC9129B919E8}")
set(ax.appId "{B2CA679F-8014-4DD1-9729-E2A3A1BEBFA9}")
set(ax.upgradeCode "{C75D4244-D0B3-4931-96D5-45E96E3EBFA6}")

set(ios.bundle_identifier "tv.dwcc.DWSpectrum")
...
set(ios.group_identifier "group.com.digitalwatchdog.DwSpectrum")
